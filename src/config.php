...
$LANGUAGES = [["en","","english.xml"],["fr","","French.xml"],["pt-br","","Portuguese.xml"],["es","","Spanish.xml"]];
...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'jmp5pepjIq8yHviI', // Random key for encryption
    ...
    "REGISTER_ACTIVATE_FIELD_NAME" => "estado",
    ...
    // Email
    "SENDER_EMAIL" => "noreply@simexamericas.org", // Sender email address
    "RECIPIENT_EMAIL" => "noreply@simexamericas.org", // Recipient email address
    ...
    "UPLOAD_TEMP_HREF_PATH" => "http://localhost:81/interpreteFile.php", // Upload temp href path (absolute URL path for download)
    ...
    "IMPORT_FILE_ALLOWED_EXT" => "csv,xls,xlsx,ppt,pptx", // Import file allowed extensions
