...
return function (App $app) {
    ...
    // docver
    $app->any('/DocverList[/{id_file}]', DocverController::class . ':list')->add(PermissionMiddleware::class)->setName('DocverList-docver-list'); // list
    $app->group(
        '/docver',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{id_file}]', DocverController::class . ':list')->add(PermissionMiddleware::class)->setName('docver/list-docver-list-2'); // list
        }
    );
    ...
    // fileuser
    $app->any('/FileuserList[/{numfile}]', FileuserController::class . ':list')->add(PermissionMiddleware::class)->setName('FileuserList-fileuser-list'); // list
    $app->group(
        '/fileuser',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{numfile}]', FileuserController::class . ':list')->add(PermissionMiddleware::class)->setName('fileuser/list-fileuser-list-2'); // list
        }
    );
    ...
    // vista_doc
    $app->any('/VistaDocList[/{id_file}]', VistaDocController::class . ':list')->add(PermissionMiddleware::class)->setName('VistaDocList-vista_doc-list'); // list
    $app->group(
        '/vista_doc',
        function (RouteCollectorProxy $group) {
            $group->any('/' . Config("LIST_ACTION") . '[/{id_file}]', VistaDocController::class . ':list')->add(PermissionMiddleware::class)->setName('vista_doc/list-vista_doc-list-2'); // list
        }
    );
