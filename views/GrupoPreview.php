...
<?php if ($Page->descripcion_grupo->Visible) { // descripcion_grupo ?>
    <?php if ($Page->SortUrl($Page->descripcion_grupo) == "") { ?>
        <th class="<?= $Page->descripcion_grupo->headerCellClass() ?>"><?= $Page->descripcion_grupo->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->descripcion_grupo->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->descripcion_grupo->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->descripcion_grupo->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->descripcion_grupo->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->descripcion_grupo->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
...
<?php if ($Page->descripcion_grupo->Visible) { // descripcion_grupo ?>
        <!-- descripcion_grupo -->
        <td<?= $Page->descripcion_grupo->cellAttributes() ?>>
