...
<title><?php echo $Language->phrase("actualizar"); ?></title>
      ...
      <div class="container-fluid">
        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title"><?php echo $Language->phrase("leermens"); ?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5><?php echo $Language->phrase("suj"); ?> <slot class="ew-slot" name="tpx_imbox_mail_sujeto"></slot></h5>
                <h6><?php echo $Language->phrase("de"); ?> <slot class="ew-slot" name="tpx_imbox_mail_reciever_userid"></slot>
...
?>
        ...
        <a class="btn btn-default ew-add-edit " title="" data-caption="Enviar" href="/homesimex/Email2Add?id_email=<?php echo CurrentPage()->id_email->CurrentValue; ?>" data-original-title="Enviar">
         <i class="fas fa-reply"></i> &nbsp;<?php echo $Language->phrase("res"); ?>
        </a>
           ...
           <?php echo $Language->phrase("reenv"); ?>&nbsp;<i class="fas fa-sign-out-alt"></i> 
        </a>
        </div>
        <!--
