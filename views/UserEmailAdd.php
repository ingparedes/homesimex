...
loadjs.ready("head", function () {
    ...
    fuser_emailadd = currentForm = new ew.Form("fuser_emailadd", "add");
    ...
    // Validate form
    fuser_emailadd.validate = function () {
    ...
    // Form_CustomValidate
    fuser_emailadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fuser_emailadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fuser_emailadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fuser_emailadd" id="fuser_emailadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
