...
$Page->showMessage();
?>
<form name="fsubgrupoadd" id="fsubgrupoadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<div id="tpd_subgrupoadd" class="ew-custom-template"></div>
<template id="tpm_subgrupoadd">
<div id="ct_SubgrupoAdd">
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_subgrupoadd", "tpm_subgrupoadd", "subgrupoadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
