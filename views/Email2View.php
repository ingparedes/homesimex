      ...
      <div class="container-fluid">
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $Language->phrase( "carpetasEv"); ?></h3>
                ...
                <ul class="nav nav-pills flex-column">
                  <li class="nav-item">
                    <a href="../Email2List" class="nav-link">
                      <i class="cil-envelope-closed"></i> <?php echo $Language->phrase( "enviadosEv"); ?> 
                      <span class="badge bg-primary float-right"></span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../ImboxMailList" class="nav-link">
                      <i class="cil-inbox"></i> <?php echo $Language->phrase( "recibidosEv"); ?>
                    </a>
                  </li>
                </ul>
              </div>
        ...
        <div class="col-md-9">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title"><?php echo $Language->phrase( "leerMensajeEv"); ?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body p-0">
              <div class="mailbox-read-info">
                <h5><?php echo $Language->phrase( "sujetoEv"); ?> <slot class="ew-slot" name="tpx_email2_sujeto"></slot></h5>
                <h6><?php echo $Language->phrase( "paraEv"); ?> <slot class="ew-slot" name="tpx_email2_sender_userid"></slot>
