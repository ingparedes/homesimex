...
$Page->showMessage();
?>
<form name="fpermisos_docedit" id="fpermisos_docedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id_usuarios->Visible) { // id_usuarios ?>
    <div id="r_id_usuarios" class="form-group row">
        <label id="elh_permisos_doc_id_usuarios" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_usuarios->caption() ?><?= $Page->id_usuarios->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
