...
-->
    ...
    <iframe id="DocumentFrame"
            ...
            width="100%"
            height="1000"
            src="https://simexamericas.org/OnlyOffice/doceditor.php?ulang=<?php echo CurrentLanguageID()?>&nameUser=<?php echo $sql['name']?>&fileID=<?php echo $file_name?>&user=<?php echo CurrentUserInfo("id_users")?>">
    </iframe>
