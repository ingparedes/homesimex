...
// Page object
$ArrowchatAdminAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var farrowchat_adminadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    farrowchat_adminadd = currentForm = new ew.Form("farrowchat_adminadd", "add");
    ...
    // Validate form
    farrowchat_adminadd.validate = function () {
    ...
    // Form_CustomValidate
    farrowchat_adminadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    farrowchat_adminadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("farrowchat_adminadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="farrowchat_adminadd" id="farrowchat_adminadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
