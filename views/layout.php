...
<link type="text/css" rel="stylesheet" id="arrowchat_css" media="all" href="/homesimex/arrowchat/external.php?type=css" charset="utf-8" />
<script type="text/javascript" src="/homesimex/arrowchat/includes/js/jquery.js"></script>
<script type="text/javascript" src="/homesimex/arrowchat/includes/js/jquery-ui.js"></script>
...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/world.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/world.ico">
...
<div class="wrapper ew-layout">
    ...
    <nav class="<?= Config("NAVBAR_CLASS") ?>">
        ...
        <ul id="ew-navbar" class="navbar-nav">
            ...
            <a class="navbar-brand d-none" href="https://simexamericas.org/homesimex/">
                <img src="<?= GetUrl("images/logolargosimex-01.png") ?>" alt="" class="brand-image ew-brand-image">
            </a>
        </ul>
        <!-- Right navbar links -->
    ...
    <aside class="<?= Config("SIDEBAR_CLASS") ?>">
        ...
        <a href="https://simexamericas.org/homesimex/" class="brand-link">
            <img src="<?= GetUrl("images/logolargosimex-01.png") ?>" alt="" class="brand-image ew-brand-image">
        </a>
        <!-- Sidebar -->
        <div class="sidebar">
...
?>
    ...
    <script type="text/javascript" src="/homesimex/arrowchat/external.php?type=djs" charset="utf-8"></script>
    <script type="text/javascript" src="/homesimex/arrowchat/external.php?type=js" charset="utf-8"></script>
</div>
<!-- ./wrapper -->
<?php } ?>
<script>
