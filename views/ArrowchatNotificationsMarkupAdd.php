...
// Page object
$ArrowchatNotificationsMarkupAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var farrowchat_notifications_markupadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    farrowchat_notifications_markupadd = currentForm = new ew.Form("farrowchat_notifications_markupadd", "add");
    ...
    farrowchat_notifications_markupadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = farrowchat_notifications_markupadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    farrowchat_notifications_markupadd.validate = function () {
    ...
    // Form_CustomValidate
    farrowchat_notifications_markupadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    farrowchat_notifications_markupadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("farrowchat_notifications_markupadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="farrowchat_notifications_markupadd" id="farrowchat_notifications_markupadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
