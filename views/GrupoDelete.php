...
loadjs.ready("head", function () {
    // Client script
    $("#swal2-content").html("Contenido del div cambiado");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fgrupodelete" id="fgrupodelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->descripcion_grupo->Visible) { // descripcion_grupo ?>
        <th class="<?= $Page->descripcion_grupo->headerCellClass() ?>"><span id="elh_grupo_descripcion_grupo" class="grupo_descripcion_grupo"><?= $Page->descripcion_grupo->caption() ?></span></th>
<?php } ?>
<?php if ($Page->color->Visible) { // color ?>
        <th class="<?= $Page->color->headerCellClass() ?>"><span id="elh_grupo_color" class="grupo_color"><?= $Page->color->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_grupo_descripcion_grupo" class="grupo_descripcion_grupo">
...
<span id="el<?= $Page->RowCount ?>_grupo_color" class="grupo_color">
