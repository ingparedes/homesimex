...
$Page->showMessage();
?>
<form name="fmensajes_usuariosview" id="fmensajes_usuariosview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->leido->Visible) { // leido ?>
    <tr id="r_leido">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mensajes_usuarios_leido"><?= $Page->leido->caption() ?></span></td>
