...
<?php } ?>
<?php if ($escenario->evento_asociado->Visible) { // evento_asociado ?>
        <tr id="r_evento_asociado">
            <td class="<?= $escenario->TableLeftColumnClass ?>"><?= $escenario->evento_asociado->caption() ?></td>
            <td <?= $escenario->evento_asociado->cellAttributes() ?>>
<span id="el_escenario_evento_asociado">
<span<?= $escenario->evento_asociado->viewAttributes() ?>>
<?= $escenario->evento_asociado->getViewValue() ?></span>
</span>
</td>
        </tr>
<?php } ?>
