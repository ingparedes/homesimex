...
<form name="fpermisos_doclistsrch" id="fpermisos_doclistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<form name="fpermisos_doclist" id="fpermisos_doclist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
