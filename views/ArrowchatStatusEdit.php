...
// Page object
$ArrowchatStatusEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var farrowchat_statusedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    farrowchat_statusedit = currentForm = new ew.Form("farrowchat_statusedit", "edit");
    ...
    farrowchat_statusedit.addFields([
    ...
    // Validate form
    farrowchat_statusedit.validate = function () {
    ...
    // Form_CustomValidate
    farrowchat_statusedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    farrowchat_statusedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    farrowchat_statusedit.lists.hide_bar = <?= $Page->hide_bar->toClientList($Page) ?>;
    farrowchat_statusedit.lists.play_sound = <?= $Page->play_sound->toClientList($Page) ?>;
    farrowchat_statusedit.lists.window_open = <?= $Page->window_open->toClientList($Page) ?>;
    farrowchat_statusedit.lists.only_names = <?= $Page->only_names->toClientList($Page) ?>;
    farrowchat_statusedit.lists.chatroom_show_names = <?= $Page->chatroom_show_names->toClientList($Page) ?>;
    farrowchat_statusedit.lists.chatroom_block_chats = <?= $Page->chatroom_block_chats->toClientList($Page) ?>;
    farrowchat_statusedit.lists.chatroom_sound = <?= $Page->chatroom_sound->toClientList($Page) ?>;
    farrowchat_statusedit.lists.announcement = <?= $Page->announcement->toClientList($Page) ?>;
    farrowchat_statusedit.lists.is_admin = <?= $Page->is_admin->toClientList($Page) ?>;
    farrowchat_statusedit.lists.is_mod = <?= $Page->is_mod->toClientList($Page) ?>;
    loadjs.done("farrowchat_statusedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="farrowchat_statusedit" id="farrowchat_statusedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="arrowchat_status" data-field="x__userid" data-hidden="1" name="o__userid" id="o__userid" value="<?= HtmlEncode($Page->_userid->OldValue ?? $Page->_userid->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->hide_bar->isInvalidClass() ?>" data-table="arrowchat_status" data-field="x_hide_bar" name="x_hide_bar[]" id="x_hide_bar_212841" value="1"<?= ConvertToBool($Page->hide_bar->CurrentValue) ? " checked" : "" ?><?= $Page->hide_bar->editAttributes() ?> aria-describedby="x_hide_bar_help">
    <label class="custom-control-label" for="x_hide_bar_212841"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->play_sound->isInvalidClass() ?>" data-table="arrowchat_status" data-field="x_play_sound" name="x_play_sound[]" id="x_play_sound_727134" value="1"<?= ConvertToBool($Page->play_sound->CurrentValue) ? " checked" : "" ?><?= $Page->play_sound->editAttributes() ?> aria-describedby="x_play_sound_help">
    <label class="custom-control-label" for="x_play_sound_727134"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->window_open->isInvalidClass() ?>" data-table="arrowchat_status" data-field="x_window_open" name="x_window_open[]" id="x_window_open_190715" value="1"<?= ConvertToBool($Page->window_open->CurrentValue) ? " checked" : "" ?><?= $Page->window_open->editAttributes() ?> aria-describedby="x_window_open_help">
    <label class="custom-control-label" for="x_window_open_190715"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->only_names->isInvalidClass() ?>" data-table="arrowchat_status" data-field="x_only_names" name="x_only_names[]" id="x_only_names_905430" value="1"<?= ConvertToBool($Page->only_names->CurrentValue) ? " checked" : "" ?><?= $Page->only_names->editAttributes() ?> aria-describedby="x_only_names_help">
    <label class="custom-control-label" for="x_only_names_905430"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->chatroom_sound->isInvalidClass() ?>" data-table="arrowchat_status" data-field="x_chatroom_sound" name="x_chatroom_sound[]" id="x_chatroom_sound_214507" value="1"<?= ConvertToBool($Page->chatroom_sound->CurrentValue) ? " checked" : "" ?><?= $Page->chatroom_sound->editAttributes() ?> aria-describedby="x_chatroom_sound_help">
    <label class="custom-control-label" for="x_chatroom_sound_214507"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->announcement->isInvalidClass() ?>" data-table="arrowchat_status" data-field="x_announcement" name="x_announcement[]" id="x_announcement_252844" value="1"<?= ConvertToBool($Page->announcement->CurrentValue) ? " checked" : "" ?><?= $Page->announcement->editAttributes() ?> aria-describedby="x_announcement_help">
    <label class="custom-control-label" for="x_announcement_252844"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->is_admin->isInvalidClass() ?>" data-table="arrowchat_status" data-field="x_is_admin" name="x_is_admin[]" id="x_is_admin_150860" value="1"<?= ConvertToBool($Page->is_admin->CurrentValue) ? " checked" : "" ?><?= $Page->is_admin->editAttributes() ?> aria-describedby="x_is_admin_help">
    <label class="custom-control-label" for="x_is_admin_150860"></label>
</div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->is_mod->isInvalidClass() ?>" data-table="arrowchat_status" data-field="x_is_mod" name="x_is_mod[]" id="x_is_mod_262205" value="1"<?= ConvertToBool($Page->is_mod->CurrentValue) ? " checked" : "" ?><?= $Page->is_mod->editAttributes() ?> aria-describedby="x_is_mod_help">
    <label class="custom-control-label" for="x_is_mod_262205"></label>
</div>
