    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top">
        ...
        <div class="dropdown navbar-user-dropdown display-mobile">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#"><?php echo $Language->phrase( "actionChirping"); ?></a>
                <a class="dropdown-item" href="#"><?php echo $Language->phrase( "anotherChirping"); ?></a>
                <a class="dropdown-item" href="#"><?php echo $Language->phrase( "somethingChirping"); ?></a>
            </div>
        </div>
        <button class="btn btn-search-bar display-mobile"><?php echo $Language->phrase("tweetChirping"); ?></button>
        ...
        <div class="navbar-collapse collapse" id="navbarCollapse" style="">
            ...
            <ul class="navbar-nav mr-auto" id="navbarsExampleDefault">
                <li class="nav-item active">
                    <a class="nav-link" href="#"><i class="octicon octicon-home iconify" data-icon="ant-design:home-filled" data-inline="false" class="" aria-hidden="true"></i> <?php echo $Language->phrase("homechirping"); ?> <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="octicon octicon-zap iconify" data-icon="bi:lightning-fill" data-inline="false"></i> <?php echo $Language->phrase("momentChirping"); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="iconify octicon octicon-bell" data-icon="ic:baseline-notifications" data-inline="false"></i> <?php echo $Language->phrase( "notiChirping"); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="octicon octicon-inbox iconify" data-icon="wpf:message" data-inline="false"></i> <?php echo $Language->phrase( "mensajesChirping"); ?></a>
                </li>
            </ul>
            ...
            <div class="left-drop">
                ...
                <button class="btn btn-search-bar display-desktop" id="refrescar" value="Actualizar"><?php echo $Language->phrase("chirping1"); ?></button>
                                ...
                                <div class="tweet-content">
                                    ...
                                    <div class="tweet-footer">
                                        <a class="tweet-footer-btn">
                                            <i class="iconify" data-icon="akar-icons:arrow-back-thick-fill" data-inline="true"></i><span> <?php echo $Language->phrase( "responderCh"); ?></span>

                                        </a>
                                        <a class="tweet-footer-btn">
                                            <i class="iconify" data-icon="akar-icons:arrow-forward-thick-fill" data-inline="true"></i><span> <?php echo $Language->phrase( "reenviarCh"); ?></span>
                                        </a>
                                        <a class="tweet-footer-btn">
                                            <i class="iconify" data-icon="ic:baseline-mark-email-read" data-inline="true"></i><span> <?php echo $Language->phrase( "leidoCh"); ?></span>
                                        </a>
                                        <a class="tweet-footer-btn">
                                            <i class="iconify" data-icon="ion:trash-bin-sharp" data-inline="true"></i><span> <?php echo $Language->phrase("eliminarCh"); ?></span>
                                        </a>
                                    </div>
                                </div>
                            </li>
