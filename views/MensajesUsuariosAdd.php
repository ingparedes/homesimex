...
loadjs.ready("head", function () {
    ...
    fmensajes_usuariosadd.lists.leido = <?= $Page->leido->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fmensajes_usuariosadd" id="fmensajes_usuariosadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->leido->isInvalidClass() ?>" data-table="mensajes_usuarios" data-field="x_leido" name="x_leido[]" id="x_leido_893189" value="1"<?= ConvertToBool($Page->leido->CurrentValue) ? " checked" : "" ?><?= $Page->leido->editAttributes() ?> aria-describedby="x_leido_help">
    <label class="custom-control-label" for="x_leido_893189"></label>
</div>
