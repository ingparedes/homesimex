...
loadjs.ready("head", function () {
    ...
    fgrupogrid.emptyRow = function (rowIndex) {
        ...
        if (ew.valueChanged(fobj, rowIndex, "nombre_grupo", false))
            return false;
        if (ew.valueChanged(fobj, rowIndex, "descripcion_grupo", false))
            return false;
...
<?php } ?>
<?php if ($Grid->descripcion_grupo->Visible) { // descripcion_grupo ?>
        <th data-name="descripcion_grupo" class="<?= $Grid->descripcion_grupo->headerCellClass() ?>"><div id="elh_grupo_descripcion_grupo" class="grupo_descripcion_grupo"><?= $Grid->renderSort($Grid->descripcion_grupo) ?></div></th>
<?php } ?>
<?php if ($Grid->color->Visible) { // color ?>
        <th data-name="color" class="<?= $Grid->color->headerCellClass() ?>"><div id="elh_grupo_color" class="grupo_color"><?= $Grid->renderSort($Grid->color) ?></div></th>
<?php } ?>
<?php
...
<?php } ?>
    ...
    <?php } ?>
    <?php if ($Grid->descripcion_grupo->Visible) { // descripcion_grupo ?>
        <td data-name="descripcion_grupo" <?= $Grid->descripcion_grupo->cellAttributes() ?>>
<?php if ($Grid->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Grid->RowCount ?>_grupo_descripcion_grupo" class="form-group">
<input type="<?= $Grid->descripcion_grupo->getInputTextType() ?>" data-table="grupo" data-field="x_descripcion_grupo" name="x<?= $Grid->RowIndex ?>_descripcion_grupo" id="x<?= $Grid->RowIndex ?>_descripcion_grupo" size="100" maxlength="100" placeholder="<?= HtmlEncode($Grid->descripcion_grupo->getPlaceHolder()) ?>" value="<?= $Grid->descripcion_grupo->EditValue ?>"<?= $Grid->descripcion_grupo->editAttributes() ?>>
<div class="invalid-feedback"><?= $Grid->descripcion_grupo->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="grupo" data-field="x_descripcion_grupo" data-hidden="1" name="o<?= $Grid->RowIndex ?>_descripcion_grupo" id="o<?= $Grid->RowIndex ?>_descripcion_grupo" value="<?= HtmlEncode($Grid->descripcion_grupo->OldValue) ?>">
<?php } ?>
<?php if ($Grid->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Grid->RowCount ?>_grupo_descripcion_grupo" class="form-group">
<input type="<?= $Grid->descripcion_grupo->getInputTextType() ?>" data-table="grupo" data-field="x_descripcion_grupo" name="x<?= $Grid->RowIndex ?>_descripcion_grupo" id="x<?= $Grid->RowIndex ?>_descripcion_grupo" size="100" maxlength="100" placeholder="<?= HtmlEncode($Grid->descripcion_grupo->getPlaceHolder()) ?>" value="<?= $Grid->descripcion_grupo->EditValue ?>"<?= $Grid->descripcion_grupo->editAttributes() ?>>
...
<?php } ?>
<?php if ($Grid->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?= $Grid->RowCount ?>_grupo_descripcion_grupo">
<span<?= $Grid->descripcion_grupo->viewAttributes() ?>>
<?= $Grid->descripcion_grupo->getViewValue() ?></span>
</span>
<?php if ($Grid->isConfirm()) { ?>
<input type="hidden" data-table="grupo" data-field="x_descripcion_grupo" data-hidden="1" name="fgrupogrid$x<?= $Grid->RowIndex ?>_descripcion_grupo" id="fgrupogrid$x<?= $Grid->RowIndex ?>_descripcion_grupo" value="<?= HtmlEncode($Grid->descripcion_grupo->FormValue) ?>">
<input type="hidden" data-table="grupo" data-field="x_descripcion_grupo" data-hidden="1" name="fgrupogrid$o<?= $Grid->RowIndex ?>_descripcion_grupo" id="fgrupogrid$o<?= $Grid->RowIndex ?>_descripcion_grupo" value="<?= HtmlEncode($Grid->descripcion_grupo->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
    <?php } ?>
...
<?php if ($Grid->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Grid->RowCount ?>_grupo_color" class="form-group">
<input type="<?= $Grid->color->getInputTextType() ?>" data-table="grupo" data-field="x_color" name="x<?= $Grid->RowIndex ?>_color" id="x<?= $Grid->RowIndex ?>_color" size="30" maxlength="30" placeholder="<?= HtmlEncode($Grid->color->getPlaceHolder()) ?>" value="<?= $Grid->color->EditValue ?>"<?= $Grid->color->editAttributes() ?>>
<div class="invalid-feedback"><?= $Grid->color->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="grupo" data-field="x_color" data-hidden="1" name="o<?= $Grid->RowIndex ?>_color" id="o<?= $Grid->RowIndex ?>_color" value="<?= HtmlEncode($Grid->color->OldValue) ?>">
<?php } ?>
<?php if ($Grid->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Grid->RowCount ?>_grupo_color" class="form-group">
<input type="hidden" data-table="grupo" data-field="x_color" data-hidden="1" name="x<?= $Grid->RowIndex ?>_color" id="x<?= $Grid->RowIndex ?>_color" value="<?= HtmlEncode($Grid->color->CurrentValue) ?>">
</span>
<?php } ?>
<?php if ($Grid->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?= $Grid->RowCount ?>_grupo_color">
<span<?= $Grid->color->viewAttributes() ?>><div class="card" style="max-width: 6rem; background-color: <?php echo CurrentPage()->color->CurrentValue; ?>;">
    <div class="card-body">
  </div>
</div>
</span>
...
<?php if ($Grid->isConfirm()) { ?>
<input type="hidden" data-table="grupo" data-field="x_color" data-hidden="1" name="fgrupogrid$x<?= $Grid->RowIndex ?>_color" id="fgrupogrid$x<?= $Grid->RowIndex ?>_color" value="<?= HtmlEncode($Grid->color->FormValue) ?>">
<input type="hidden" data-table="grupo" data-field="x_color" data-hidden="1" name="fgrupogrid$o<?= $Grid->RowIndex ?>_color" id="fgrupogrid$o<?= $Grid->RowIndex ?>_color" value="<?= HtmlEncode($Grid->color->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
    <?php } ?>
...
<input type="hidden" data-table="grupo" data-field="x_nombre_grupo" data-hidden="1" name="o<?= $Grid->RowIndex ?>_nombre_grupo" id="o<?= $Grid->RowIndex ?>_nombre_grupo" value="<?= HtmlEncode($Grid->nombre_grupo->OldValue) ?>">
    ...
    <?php } ?>
    <?php if ($Grid->descripcion_grupo->Visible) { // descripcion_grupo ?>
        <td data-name="descripcion_grupo">
<?php if (!$Grid->isConfirm()) { ?>
<span id="el$rowindex$_grupo_descripcion_grupo" class="form-group grupo_descripcion_grupo">
<input type="<?= $Grid->descripcion_grupo->getInputTextType() ?>" data-table="grupo" data-field="x_descripcion_grupo" name="x<?= $Grid->RowIndex ?>_descripcion_grupo" id="x<?= $Grid->RowIndex ?>_descripcion_grupo" size="100" maxlength="100" placeholder="<?= HtmlEncode($Grid->descripcion_grupo->getPlaceHolder()) ?>" value="<?= $Grid->descripcion_grupo->EditValue ?>"<?= $Grid->descripcion_grupo->editAttributes() ?>>
<div class="invalid-feedback"><?= $Grid->descripcion_grupo->getErrorMessage() ?></div>
</span>
<?php } else { ?>
<span id="el$rowindex$_grupo_descripcion_grupo" class="form-group grupo_descripcion_grupo">
<span<?= $Grid->descripcion_grupo->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Grid->descripcion_grupo->getDisplayValue($Grid->descripcion_grupo->ViewValue))) ?>"></span>
</span>
<input type="hidden" data-table="grupo" data-field="x_descripcion_grupo" data-hidden="1" name="x<?= $Grid->RowIndex ?>_descripcion_grupo" id="x<?= $Grid->RowIndex ?>_descripcion_grupo" value="<?= HtmlEncode($Grid->descripcion_grupo->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="grupo" data-field="x_descripcion_grupo" data-hidden="1" name="o<?= $Grid->RowIndex ?>_descripcion_grupo" id="o<?= $Grid->RowIndex ?>_descripcion_grupo" value="<?= HtmlEncode($Grid->descripcion_grupo->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Grid->color->Visible) { // color ?>
        <td data-name="color">
<?php if (!$Grid->isConfirm()) { ?>
<span id="el$rowindex$_grupo_color" class="form-group grupo_color">
<input type="<?= $Grid->color->getInputTextType() ?>" data-table="grupo" data-field="x_color" name="x<?= $Grid->RowIndex ?>_color" id="x<?= $Grid->RowIndex ?>_color" size="30" maxlength="30" placeholder="<?= HtmlEncode($Grid->color->getPlaceHolder()) ?>" value="<?= $Grid->color->EditValue ?>"<?= $Grid->color->editAttributes() ?>>
<div class="invalid-feedback"><?= $Grid->color->getErrorMessage() ?></div>
</span>
<?php } else { ?>
<input type="hidden" data-table="grupo" data-field="x_color" data-hidden="1" name="x<?= $Grid->RowIndex ?>_color" id="x<?= $Grid->RowIndex ?>_color" value="<?= HtmlEncode($Grid->color->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="grupo" data-field="x_color" data-hidden="1" name="o<?= $Grid->RowIndex ?>_color" id="o<?= $Grid->RowIndex ?>_color" value="<?= HtmlEncode($Grid->color->OldValue) ?>">
</td>
    <?php } ?>
