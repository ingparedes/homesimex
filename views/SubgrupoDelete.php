...
$Page->showMessage();
?>
<form name="fsubgrupodelete" id="fsubgrupodelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->descripcion_subgrupo->Visible) { // descripcion_subgrupo ?>
        <th class="<?= $Page->descripcion_subgrupo->headerCellClass() ?>"><span id="elh_subgrupo_descripcion_subgrupo" class="subgrupo_descripcion_subgrupo"><?= $Page->descripcion_subgrupo->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_subgrupo_descripcion_subgrupo" class="subgrupo_descripcion_subgrupo">
