...
loadjs.ready("head", function () {
    ...
    fsubgrupogrid.emptyRow = function (rowIndex) {
        ...
        if (ew.valueChanged(fobj, rowIndex, "nombre_subgrupo", false))
            return false;
        if (ew.valueChanged(fobj, rowIndex, "descripcion_subgrupo", false))
            return false;
        return true;
    }
...
<?php } ?>
<?php if ($Grid->descripcion_subgrupo->Visible) { // descripcion_subgrupo ?>
        <th data-name="descripcion_subgrupo" class="<?= $Grid->descripcion_subgrupo->headerCellClass() ?>"><div id="elh_subgrupo_descripcion_subgrupo" class="subgrupo_descripcion_subgrupo"><?= $Grid->renderSort($Grid->descripcion_subgrupo) ?></div></th>
<?php } ?>
<?php
...
<?php } ?>
    ...
    <?php } ?>
    <?php if ($Grid->descripcion_subgrupo->Visible) { // descripcion_subgrupo ?>
        <td data-name="descripcion_subgrupo" <?= $Grid->descripcion_subgrupo->cellAttributes() ?>>
<?php if ($Grid->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Grid->RowCount ?>_subgrupo_descripcion_subgrupo" class="form-group">
<input type="<?= $Grid->descripcion_subgrupo->getInputTextType() ?>" data-table="subgrupo" data-field="x_descripcion_subgrupo" name="x<?= $Grid->RowIndex ?>_descripcion_subgrupo" id="x<?= $Grid->RowIndex ?>_descripcion_subgrupo" size="100" maxlength="100" placeholder="<?= HtmlEncode($Grid->descripcion_subgrupo->getPlaceHolder()) ?>" value="<?= $Grid->descripcion_subgrupo->EditValue ?>"<?= $Grid->descripcion_subgrupo->editAttributes() ?>>
<div class="invalid-feedback"><?= $Grid->descripcion_subgrupo->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="subgrupo" data-field="x_descripcion_subgrupo" data-hidden="1" name="o<?= $Grid->RowIndex ?>_descripcion_subgrupo" id="o<?= $Grid->RowIndex ?>_descripcion_subgrupo" value="<?= HtmlEncode($Grid->descripcion_subgrupo->OldValue) ?>">
<?php } ?>
<?php if ($Grid->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Grid->RowCount ?>_subgrupo_descripcion_subgrupo" class="form-group">
<input type="<?= $Grid->descripcion_subgrupo->getInputTextType() ?>" data-table="subgrupo" data-field="x_descripcion_subgrupo" name="x<?= $Grid->RowIndex ?>_descripcion_subgrupo" id="x<?= $Grid->RowIndex ?>_descripcion_subgrupo" size="100" maxlength="100" placeholder="<?= HtmlEncode($Grid->descripcion_subgrupo->getPlaceHolder()) ?>" value="<?= $Grid->descripcion_subgrupo->EditValue ?>"<?= $Grid->descripcion_subgrupo->editAttributes() ?>>
...
<?php } ?>
<?php if ($Grid->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?= $Grid->RowCount ?>_subgrupo_descripcion_subgrupo">
<span<?= $Grid->descripcion_subgrupo->viewAttributes() ?>>
<?= $Grid->descripcion_subgrupo->getViewValue() ?></span>
</span>
<?php if ($Grid->isConfirm()) { ?>
<input type="hidden" data-table="subgrupo" data-field="x_descripcion_subgrupo" data-hidden="1" name="fsubgrupogrid$x<?= $Grid->RowIndex ?>_descripcion_subgrupo" id="fsubgrupogrid$x<?= $Grid->RowIndex ?>_descripcion_subgrupo" value="<?= HtmlEncode($Grid->descripcion_subgrupo->FormValue) ?>">
<input type="hidden" data-table="subgrupo" data-field="x_descripcion_subgrupo" data-hidden="1" name="fsubgrupogrid$o<?= $Grid->RowIndex ?>_descripcion_subgrupo" id="fsubgrupogrid$o<?= $Grid->RowIndex ?>_descripcion_subgrupo" value="<?= HtmlEncode($Grid->descripcion_subgrupo->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
    <?php } ?>
...
<input type="hidden" data-table="subgrupo" data-field="x_nombre_subgrupo" data-hidden="1" name="o<?= $Grid->RowIndex ?>_nombre_subgrupo" id="o<?= $Grid->RowIndex ?>_nombre_subgrupo" value="<?= HtmlEncode($Grid->nombre_subgrupo->OldValue) ?>">
    ...
    <?php } ?>
    <?php if ($Grid->descripcion_subgrupo->Visible) { // descripcion_subgrupo ?>
        <td data-name="descripcion_subgrupo">
<?php if (!$Grid->isConfirm()) { ?>
<span id="el$rowindex$_subgrupo_descripcion_subgrupo" class="form-group subgrupo_descripcion_subgrupo">
<input type="<?= $Grid->descripcion_subgrupo->getInputTextType() ?>" data-table="subgrupo" data-field="x_descripcion_subgrupo" name="x<?= $Grid->RowIndex ?>_descripcion_subgrupo" id="x<?= $Grid->RowIndex ?>_descripcion_subgrupo" size="100" maxlength="100" placeholder="<?= HtmlEncode($Grid->descripcion_subgrupo->getPlaceHolder()) ?>" value="<?= $Grid->descripcion_subgrupo->EditValue ?>"<?= $Grid->descripcion_subgrupo->editAttributes() ?>>
<div class="invalid-feedback"><?= $Grid->descripcion_subgrupo->getErrorMessage() ?></div>
</span>
<?php } else { ?>
<span id="el$rowindex$_subgrupo_descripcion_subgrupo" class="form-group subgrupo_descripcion_subgrupo">
<span<?= $Grid->descripcion_subgrupo->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Grid->descripcion_subgrupo->getDisplayValue($Grid->descripcion_subgrupo->ViewValue))) ?>"></span>
</span>
<input type="hidden" data-table="subgrupo" data-field="x_descripcion_subgrupo" data-hidden="1" name="x<?= $Grid->RowIndex ?>_descripcion_subgrupo" id="x<?= $Grid->RowIndex ?>_descripcion_subgrupo" value="<?= HtmlEncode($Grid->descripcion_subgrupo->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="subgrupo" data-field="x_descripcion_subgrupo" data-hidden="1" name="o<?= $Grid->RowIndex ?>_descripcion_subgrupo" id="o<?= $Grid->RowIndex ?>_descripcion_subgrupo" value="<?= HtmlEncode($Grid->descripcion_subgrupo->OldValue) ?>">
</td>
    <?php } ?>
