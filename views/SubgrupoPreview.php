...
<?php if ($Page->descripcion_subgrupo->Visible) { // descripcion_subgrupo ?>
    <?php if ($Page->SortUrl($Page->descripcion_subgrupo) == "") { ?>
        <th class="<?= $Page->descripcion_subgrupo->headerCellClass() ?>"><?= $Page->descripcion_subgrupo->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->descripcion_subgrupo->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->descripcion_subgrupo->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->descripcion_subgrupo->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->descripcion_subgrupo->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->descripcion_subgrupo->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
<?php
...
<?php if ($Page->descripcion_subgrupo->Visible) { // descripcion_subgrupo ?>
        ...
        <td<?= $Page->descripcion_subgrupo->cellAttributes() ?>>
