...
loadjs.ready("head", function () {
    ...
    fcalificacionadd = currentForm = new ew.Form("fcalificacionadd", "add");
    ...
    fcalificacionadd.addFields([
        ["descripcion", [fields.descripcion.visible && fields.descripcion.required ? ew.Validators.required(fields.descripcion.caption) : null], fields.descripcion.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = fcalificacionadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fcalificacionadd.validate = function () {
    ...
    // Form_CustomValidate
    fcalificacionadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcalificacionadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcalificacionadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcalificacionadd" id="fcalificacionadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
