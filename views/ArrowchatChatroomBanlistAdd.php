...
// Page object
$ArrowchatChatroomBanlistAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var farrowchat_chatroom_banlistadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    farrowchat_chatroom_banlistadd = currentForm = new ew.Form("farrowchat_chatroom_banlistadd", "add");
    ...
    farrowchat_chatroom_banlistadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = farrowchat_chatroom_banlistadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    farrowchat_chatroom_banlistadd.validate = function () {
    ...
    // Form_CustomValidate
    farrowchat_chatroom_banlistadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    farrowchat_chatroom_banlistadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("farrowchat_chatroom_banlistadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="farrowchat_chatroom_banlistadd" id="farrowchat_chatroom_banlistadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
