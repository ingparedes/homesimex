...
loadjs.ready("head", function () {
    ...
    fescenarioedit.lists.evento_asociado = <?= $Page->evento_asociado->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fescenarioedit" id="fescenarioedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
