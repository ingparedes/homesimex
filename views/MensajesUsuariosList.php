...
<form name="fmensajes_usuarioslist" id="fmensajes_usuarioslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->leido->Visible) { // leido ?>
        <th data-name="leido" class="<?= $Page->leido->headerCellClass() ?>"><div id="elh_mensajes_usuarios_leido" class="mensajes_usuarios_leido"><?= $Page->renderSort($Page->leido) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_mensajes_usuarios_leido">
