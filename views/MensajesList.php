...
.ew-table-preview-row { /* main table preview row color */
    background-color: #778899; /* preview row color */
}
...
<form name="fmensajeslistsrch" id="fmensajeslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fmensajeslist" id="fmensajeslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
