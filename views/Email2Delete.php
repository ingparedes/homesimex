...
$Page->showMessage();
?>
<form name="femail2delete" id="femail2delete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id_mensaje->Visible) { // id_mensaje ?>
        <th class="<?= $Page->id_mensaje->headerCellClass() ?>"><span id="elh_email2_id_mensaje" class="email2_id_mensaje"><?= $Page->id_mensaje->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_email2_id_mensaje" class="email2_id_mensaje">
