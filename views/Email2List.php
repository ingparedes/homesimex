...
<form name="femail2listsrch" id="femail2listsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="femail2list" id="femail2list" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id_mensaje->Visible) { // id_mensaje ?>
        <th data-name="id_mensaje" class="<?= $Page->id_mensaje->headerCellClass() ?>"><div id="elh_email2_id_mensaje" class="email2_id_mensaje"><?= $Page->renderSort($Page->id_mensaje) ?></div></th>
<?php } ?>
<?php
...
<template id="tpx<?= $Page->RowCount ?>_email2_id_mensaje"><span id="el<?= $Page->RowCount ?>_email2_id_mensaje">
      ...
      <div class="row" id="inbox">
                ...
                <ul class="nav nav-pills flex-column">
                  <li class="nav-item">
                    <a href="Email2List" class="nav-link">
                      <i class="cil-envelope-closed"></i> <?php echo $Language->phrase( "enviadosEm"); ?>
                      <span class="badge bg-primary float-right"></span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="ImboxMailList" class="nav-link">
                      <i class="cil-inbox"></i> <?php echo $Language->phrase( "recibidosEm"); ?>
                    </a>
                  </li>
              </ul>
            </div>
        ...
        <div class="col-9">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title"><?php echo $Language->phrase( "enviadosEm2"); ?></h3>
              <!-- /.card-tools -->
          </div>
            <!-- /.card-header -->
...
<div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                  <tr>
                  <td class="mailbox-name" width="10%"><?php echo $Language->phrase( "paraEm"); ?></td>
                   <td class="mailbox-name" width="30%"><slot class="ew-slot" name="tpx<?= $i ?>_email2_sender_userid"></slot></td>
                    ...
                    <td class="mailbox-date" width="10%"><small><slot class="ew-slot" name="tpx<?= $i ?>_email2_tiempo"></slot></small></td>
...
loadjs.ready("load", function () {
    // Startup script
    $(".ew-submit").html("Enviar"),$(".card.ew-card.ew-grid.email2").removeClass("ew-grid");
});
</script>
<?php } ?>
