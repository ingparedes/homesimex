...
// Page object
$PermisosDocusersAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpermisos_docusersadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpermisos_docusersadd = currentForm = new ew.Form("fpermisos_docusersadd", "add");
    ...
    fpermisos_docusersadd.addFields([
    ...
    // Validate form
    fpermisos_docusersadd.validate = function () {
    ...
    // Form_CustomValidate
    fpermisos_docusersadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpermisos_docusersadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpermisos_docusersadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpermisos_docusersadd" id="fpermisos_docusersadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpermisos_docusersadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpermisos_docusersadd", "x_date_created", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
