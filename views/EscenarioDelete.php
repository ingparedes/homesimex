...
$Page->showMessage();
?>
<form name="fescenariodelete" id="fescenariodelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->evento_asociado->Visible) { // evento_asociado ?>
        <th class="<?= $Page->evento_asociado->headerCellClass() ?>"><span id="elh_escenario_evento_asociado" class="escenario_evento_asociado"><?= $Page->evento_asociado->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->evento_asociado->Visible) { // evento_asociado ?>
        <td <?= $Page->evento_asociado->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_escenario_evento_asociado" class="escenario_evento_asociado">
