...
$Page->showMessage();
?>
<form name="fmensajes_usuariosdelete" id="fmensajes_usuariosdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->leido->Visible) { // leido ?>
        <th class="<?= $Page->leido->headerCellClass() ?>"><span id="elh_mensajes_usuarios_leido" class="mensajes_usuarios_leido"><?= $Page->leido->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_mensajes_usuarios_leido" class="mensajes_usuarios_leido">
