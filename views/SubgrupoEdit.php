...
$Page->showMessage();
?>
<form name="fsubgrupoedit" id="fsubgrupoedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id_subgrupo->Visible) { // id_subgrupo ?>
    <div id="r_id_subgrupo" class="form-group row">
        <label id="elh_subgrupo_id_subgrupo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_subgrupo_id_subgrupo"><?= $Page->id_subgrupo->caption() ?><?= $Page->id_subgrupo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_subgrupo->cellAttributes() ?>>
<template id="tpx_subgrupo_id_subgrupo"><span id="el_subgrupo_id_subgrupo">
...
<?php if ($Page->id_grupo->Visible) { // id_grupo ?>
    <div id="r_id_grupo" class="form-group row">
        <label id="elh_subgrupo_id_grupo" for="x_id_grupo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_subgrupo_id_grupo"><?= $Page->id_grupo->caption() ?><?= $Page->id_grupo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_grupo->cellAttributes() ?>>
<?php if ($Page->id_grupo->getSessionValue() != "") { ?>
<template id="tpx_subgrupo_id_grupo"><span id="el_subgrupo_id_grupo">
...
<?php if ($Page->imagen_subgrupo->Visible) { // imagen_subgrupo ?>
    <div id="r_imagen_subgrupo" class="form-group row">
        <label id="elh_subgrupo_imagen_subgrupo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_subgrupo_imagen_subgrupo"><?= $Page->imagen_subgrupo->caption() ?><?= $Page->imagen_subgrupo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->imagen_subgrupo->cellAttributes() ?>>
<template id="tpx_subgrupo_imagen_subgrupo"><span id="el_subgrupo_imagen_subgrupo">
...
<?php if ($Page->nombre_subgrupo->Visible) { // nombre_subgrupo ?>
    <div id="r_nombre_subgrupo" class="form-group row">
        <label id="elh_subgrupo_nombre_subgrupo" for="x_nombre_subgrupo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_subgrupo_nombre_subgrupo"><?= $Page->nombre_subgrupo->caption() ?><?= $Page->nombre_subgrupo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->nombre_subgrupo->cellAttributes() ?>>
<template id="tpx_subgrupo_nombre_subgrupo"><span id="el_subgrupo_nombre_subgrupo">
...
<?php if ($Page->descripcion_subgrupo->Visible) { // descripcion_subgrupo ?>
    <div id="r_descripcion_subgrupo" class="form-group row">
        <label id="elh_subgrupo_descripcion_subgrupo" for="x_descripcion_subgrupo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_subgrupo_descripcion_subgrupo"><?= $Page->descripcion_subgrupo->caption() ?><?= $Page->descripcion_subgrupo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->descripcion_subgrupo->cellAttributes() ?>>
<template id="tpx_subgrupo_descripcion_subgrupo"><span id="el_subgrupo_descripcion_subgrupo">
<input type="<?= $Page->descripcion_subgrupo->getInputTextType() ?>" data-table="subgrupo" data-field="x_descripcion_subgrupo" name="x_descripcion_subgrupo" id="x_descripcion_subgrupo" size="100" maxlength="100" placeholder="<?= HtmlEncode($Page->descripcion_subgrupo->getPlaceHolder()) ?>" value="<?= $Page->descripcion_subgrupo->EditValue ?>"<?= $Page->descripcion_subgrupo->editAttributes() ?> aria-describedby="x_descripcion_subgrupo_help">
...
<div id="tpd_subgrupoedit" class="ew-custom-template"></div>
<template id="tpm_subgrupoedit">
<div id="ct_SubgrupoEdit">    <div id="r_nombre_subgrupo" class="form-group">
        <label for="x_nombre_subgrupo" class="col-sm-2 col-form-label"><?= $Page->nombre_subgrupo->caption() ?></label>
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_subgrupo_nombre_subgrupo"></slot></div>
    </div>
    <div id="r_descripcion_subgrupo" class="form-group">
        <label for="x_descripcion_subgrupo" class="col-sm-2 col-form-label"><?= $Page->descripcion_subgrupo->caption() ?></label>
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_subgrupo_descripcion_subgrupo"></slot></div>
    </div>
    <div id="r_imagen_subgrupo" class="form-group">
        <label for="x_imagen_subgrupo" class="col-sm-2 col-form-label"><?= $Page->imagen_subgrupo->caption() ?></label>
        <div class="col-sm-10"><slot class="ew-slot" name="tpx_subgrupo_imagen_subgrupo"></slot></div>
    </div>
</div>
</template>
<?php
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_subgrupoedit", "tpm_subgrupoedit", "subgrupoedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
