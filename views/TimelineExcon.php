        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <button type="button" id="btnRedi"onclick="location.href='./MensajesEdit/230?showmaster=tareas&fk_id_tarea=109'" href="." class="btn btn-info btn-sm mr-auto">Editar provi</button>
--> 
