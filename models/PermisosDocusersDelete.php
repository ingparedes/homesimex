 ...
 * Page class
 */
class PermisosDocusersDelete extends PermisosDocusers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PermisosDocusersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PermisosDocusersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PermisosDocusersList"); // Return to list
                return;
            }
        }
