...
class Grupo extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->imgen_grupo->ImageResize = true;
        ...
        $this->nombre_grupo->Required = true; // Required field
        ...
        // color
        $this->color = new DbField('grupo', 'grupo', 'x_color', 'color', '`color`', '`color`', 200, 100, -1, false, '`color`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // color_grup
        $this->color_grup = new DbField('grupo', 'grupo', 'x_color_grup', 'color_grup', '`color_grup`', '`color_grup`', 200, 100, -1, false, '`color_grup`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->color_grup->Sortable = false; // Allow sort
        $this->color_grup->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->color_grup->Param, "CustomMsg");
        $this->Fields['color_grup'] = &$this->color_grup;
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->color_grup->DbValue = $row['color_grup'];
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // color_grup
        $this->color_grup->CellCssStyle = "white-space: nowrap;";
        ...
        // color_grup
        $this->color_grup->ViewValue = $this->color_grup->CurrentValue;
        $this->color_grup->ViewCustomAttributes = "";
        ...
        // color_grup
        $this->color_grup->LinkCustomAttributes = "";
        $this->color_grup->HrefValue = "";
        $this->color_grup->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // color_grup
        $this->color_grup->EditAttrs["class"] = "form-control";
        $this->color_grup->EditCustomAttributes = "";
        if (!$this->color_grup->Raw) {
            $this->color_grup->CurrentValue = HtmlDecode($this->color_grup->CurrentValue);
        }
        $this->color_grup->EditValue = $this->color_grup->CurrentValue;
        $this->color_grup->PlaceHolder = RemoveHtml($this->color_grup->caption());
    ...
    public function rowInserted($rsold, &$rsnew)
    {
        ...
        $sqlchat = Execute("INSERT INTO `arrowchat_chatroom_rooms`(`author_id`, `name`, `description`, `welcome_message`, `type`, `length`, `is_featured`, `disallowed_groups`, `session_time`) VALUES ('1', ' $nombre', '$nomgr', 'Bienvenidos', 1, 0, 1, 's;1:\"0\":', 0)");
