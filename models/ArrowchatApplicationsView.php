 ...
 * Page class
 */
class ArrowchatApplicationsView extends ArrowchatApplications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatApplicationsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ArrowchatApplicationsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ArrowchatApplicationsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ArrowchatApplicationsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
