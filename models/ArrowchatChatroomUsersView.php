 ...
 * Page class
 */
class ArrowchatChatroomUsersView extends ArrowchatChatroomUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatChatroomUsersView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("chatroom_id") ?? Route("chatroom_id")) !== null) {
            $this->RecKey["chatroom_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("user_id") ?? Route("user_id")) !== null) {
                ...
                $returnUrl = "ArrowchatChatroomUsersList"; // Return to list
            }
            if (($keyValue = Get("chatroom_id") ?? Route("chatroom_id")) !== null) {
                $this->chatroom_id->setQueryStringValue($keyValue);
                $this->RecKey["chatroom_id"] = $this->chatroom_id->QueryStringValue;
            } elseif (Post("chatroom_id") !== null) {
                $this->chatroom_id->setFormValue(Post("chatroom_id"));
                $this->RecKey["chatroom_id"] = $this->chatroom_id->FormValue;
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ArrowchatChatroomUsersList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ArrowchatChatroomUsersList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
