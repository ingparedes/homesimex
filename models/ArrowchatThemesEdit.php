 ...
 * Page class
 */
class ArrowchatThemesEdit extends ArrowchatThemes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatThemesEdit";
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if ($pageName != $this->getListUrl()) { // Not List page
                    ...
                    if ($pageName == "ArrowchatThemesView") {
                        $row["view"] = "1";
                    }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("ArrowchatThemesList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ArrowchatThemesList") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // folder
            $this->folder->setDbValueDef($rsnew, $this->folder->CurrentValue, "", $this->folder->ReadOnly);
            ...
            // update_link
            $this->update_link->setDbValueDef($rsnew, $this->update_link->CurrentValue, null, $this->update_link->ReadOnly);

            // version
            $this->version->setDbValueDef($rsnew, $this->version->CurrentValue, null, $this->version->ReadOnly);
            ...
            $this->_default->setDbValueDef($rsnew, $tmpBool, 0, $this->_default->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ArrowchatThemesList"), "", $this->TableVar, true);
        $pageId = "edit";
