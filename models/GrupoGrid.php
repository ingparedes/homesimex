...
class GrupoGrid extends Grupo
{
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_descripcion_grupo") && $CurrentForm->hasValue("o_descripcion_grupo") && $this->descripcion_grupo->CurrentValue != $this->descripcion_grupo->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->descripcion_grupo->clearErrorMessage();
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->color_grup->CurrentValue = null;
        $this->color_grup->OldValue = $this->color_grup->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_descripcion_grupo")) {
            $this->descripcion_grupo->setOldValue($CurrentForm->getValue("o_descripcion_grupo"));
        }
    ...
    protected function newRow()
    {
        ...
        $row['color_grup'] = $this->color_grup->CurrentValue;
        return $row;
    }
