 ...
 * Page class
 */
class CalificacionEmailView extends CalificacionEmail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CalificacionEmailView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_calificacion_email") ?? Route("id_calificacion_email")) !== null) {
            $this->RecKey["id_calificacion_email"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_calificacion_email") ?? Route("id_calificacion_email")) !== null) {
                ...
                $this->RecKey["id_calificacion_email"] = $this->id_calificacion_email->QueryStringValue;
            } elseif (Post("id_calificacion_email") !== null) {
                $this->id_calificacion_email->setFormValue(Post("id_calificacion_email"));
                $this->RecKey["id_calificacion_email"] = $this->id_calificacion_email->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_calificacion_email->setQueryStringValue($keyValue);
                $this->RecKey["id_calificacion_email"] = $this->id_calificacion_email->QueryStringValue;
            } else {
                $returnUrl = "CalificacionEmailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CalificacionEmailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "CalificacionEmailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
