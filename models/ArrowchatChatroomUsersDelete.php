 ...
 * Page class
 */
class ArrowchatChatroomUsersDelete extends ArrowchatChatroomUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatChatroomUsersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ArrowchatChatroomUsersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ArrowchatChatroomUsersList"); // Return to list
                return;
            }
        }
