 ...
 * Page class
 */
class CalificacionEmailDelete extends CalificacionEmail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CalificacionEmailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CalificacionEmailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CalificacionEmailList"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                $thisKey .= $row['id_calificacion_email'];
