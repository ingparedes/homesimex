...
class TareasList extends Tareas
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->valoracion->AdvancedSearch->toJson(), ","); // Field valoracion
    ...
    protected function restoreFilterList()
    {
        ...
        // Field valoracion
        $this->valoracion->AdvancedSearch->SearchValue = @$filter["x_valoracion"];
        $this->valoracion->AdvancedSearch->SearchOperator = @$filter["z_valoracion"];
        $this->valoracion->AdvancedSearch->SearchCondition = @$filter["v_valoracion"];
        $this->valoracion->AdvancedSearch->SearchValue2 = @$filter["y_valoracion"];
        $this->valoracion->AdvancedSearch->SearchOperator2 = @$filter["w_valoracion"];
        $this->valoracion->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->valoracion, $default, false); // valoracion
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->valoracion->AdvancedSearch->save(); // valoracion
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->valoracion->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->valoracion->AdvancedSearch->unsetSession();
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'mensajes')) {
            ...
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'tareas')) {
    ...
    protected function renderListOptionsExt()
    {
        ...
        $links = "";
        $btngrps = "";
        $sqlwrk = "`id_tarea`=" . AdjustSql($this->id_tarea->CurrentValue, $this->Dbid) . "";
        ...
        if ($this->DetailPages && $this->DetailPages["mensajes"] && $this->DetailPages["mensajes"]->Visible) {
            ...
            $btngrp = "<div data-table=\"mensajes\" data-url=\"" . $url . "\">";
            if ($Security->allowList(CurrentProjectID() . 'tareas')) {
                ...
                $btngrp .= "<a href=\"#\" class=\"mr-2\" title=\"" . $Language->TablePhrase("mensajes", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "';return false;\">" . $Language->phrase("MasterDetailListLink") . "</a>";
            }
    ...
    protected function loadSearchValues()
    {
        ...
        if (is_array($this->id_grupo->AdvancedSearch->SearchValue)) {
            $this->id_grupo->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->id_grupo->AdvancedSearch->SearchValue);
        }
        if (is_array($this->id_grupo->AdvancedSearch->SearchValue2)) {
            $this->id_grupo->AdvancedSearch->SearchValue2 = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->id_grupo->AdvancedSearch->SearchValue2);
        }
        ...
        // valoracion
        if (!$this->isAddOrEdit() && $this->valoracion->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->valoracion->AdvancedSearch->SearchValue != "" || $this->valoracion->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
