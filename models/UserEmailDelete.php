 ...
 * Page class
 */
class UserEmailDelete extends UserEmail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserEmailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UserEmailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("UserEmailList"); // Return to list
                return;
            }
        }
