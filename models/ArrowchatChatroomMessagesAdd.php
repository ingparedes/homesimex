 ...
 * Page class
 */
class ArrowchatChatroomMessagesAdd extends ArrowchatChatroomMessages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatChatroomMessagesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ArrowchatChatroomMessagesView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->global_message->CurrentValue = 0;
    ...
    protected function newRow()
    {
        ...
        $row['global_message'] = $this->global_message->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        $this->global_message->setDbValueDef($rsnew, $tmpBool, null, strval($this->global_message->CurrentValue) == "");
        ...
        $this->is_mod->setDbValueDef($rsnew, $tmpBool, null, strval($this->is_mod->CurrentValue) == "");
        ...
        $this->is_admin->setDbValueDef($rsnew, $tmpBool, null, strval($this->is_admin->CurrentValue) == "");
        ...
        $this->_action->setDbValueDef($rsnew, $tmpBool, null, strval($this->_action->CurrentValue) == "");
