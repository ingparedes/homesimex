...
/**
 * Table class for tbl_task
 */
class TblTask extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'tbl_task';
        $this->TableName = 'tbl_task';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`tbl_task`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('tbl_task', 'tbl_task', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // title
        $this->title = new DbField('tbl_task', 'tbl_task', 'x_title', 'title', '`title`', '`title`', 200, 255, -1, false, '`title`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // description
        $this->description = new DbField('tbl_task', 'tbl_task', 'x_description', 'description', '`description`', '`description`', 201, 65535, -1, false, '`description`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->description->Sortable = true; // Allow sort
        $this->description->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->description->Param, "CustomMsg");
        $this->Fields['description'] = &$this->description;

        // project_name
        $this->project_name = new DbField('tbl_task', 'tbl_task', 'x_project_name', 'project_name', '`project_name`', '`project_name`', 200, 255, -1, false, '`project_name`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        $this->project_name->Sortable = true; // Allow sort
        $this->project_name->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->project_name->Param, "CustomMsg");
        $this->Fields['project_name'] = &$this->project_name;

        // status_id
        $this->status_id = new DbField('tbl_task', 'tbl_task', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 3, 11, -1, false, '`status_id`', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // created_at
        $this->created_at = new DbField('tbl_task', 'tbl_task', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, false, '`created_at`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_users
        $this->id_users = new DbField('tbl_task', 'tbl_task', 'x_id_users', 'id_users', '`id_users`', '`id_users`', 3, 11, -1, false, '`id_users`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`tbl_task`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TblTaskList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TblTaskView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TblTaskEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TblTaskAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TblTaskView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TblTaskView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TblTaskAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TblTaskAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TblTaskEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TblTaskAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TblTaskDelete", $this->getUrlParm());
    }
