 ...
 * Page class
 */
class ArrowchatApplicationsList extends ArrowchatApplications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatApplicationsList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "farrowchat_applicationslist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ArrowchatApplicationsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ArrowchatApplicationsDelete";
        $this->MultiUpdateUrl = "ArrowchatApplicationsUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option farrowchat_applicationslistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->folder->AdvancedSearch->toJson(), ","); // Field folder
        ...
        $filterList = Concat($filterList, $this->bar_width->AdvancedSearch->toJson(), ","); // Field bar_width
        $filterList = Concat($filterList, $this->bar_name->AdvancedSearch->toJson(), ","); // Field bar_name
        $filterList = Concat($filterList, $this->dont_reload->AdvancedSearch->toJson(), ","); // Field dont_reload
        $filterList = Concat($filterList, $this->default_bookmark->AdvancedSearch->toJson(), ","); // Field default_bookmark
        $filterList = Concat($filterList, $this->show_to_guests->AdvancedSearch->toJson(), ","); // Field show_to_guests
        $filterList = Concat($filterList, $this->link->AdvancedSearch->toJson(), ","); // Field link
        $filterList = Concat($filterList, $this->update_link->AdvancedSearch->toJson(), ","); // Field update_link
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "farrowchat_applicationslistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field bar_width
        $this->bar_width->AdvancedSearch->SearchValue = @$filter["x_bar_width"];
        $this->bar_width->AdvancedSearch->SearchOperator = @$filter["z_bar_width"];
        $this->bar_width->AdvancedSearch->SearchCondition = @$filter["v_bar_width"];
        $this->bar_width->AdvancedSearch->SearchValue2 = @$filter["y_bar_width"];
        $this->bar_width->AdvancedSearch->SearchOperator2 = @$filter["w_bar_width"];
        $this->bar_width->AdvancedSearch->save();

        // Field bar_name
        $this->bar_name->AdvancedSearch->SearchValue = @$filter["x_bar_name"];
        $this->bar_name->AdvancedSearch->SearchOperator = @$filter["z_bar_name"];
        $this->bar_name->AdvancedSearch->SearchCondition = @$filter["v_bar_name"];
        $this->bar_name->AdvancedSearch->SearchValue2 = @$filter["y_bar_name"];
        $this->bar_name->AdvancedSearch->SearchOperator2 = @$filter["w_bar_name"];
        $this->bar_name->AdvancedSearch->save();

        // Field dont_reload
        $this->dont_reload->AdvancedSearch->SearchValue = @$filter["x_dont_reload"];
        $this->dont_reload->AdvancedSearch->SearchOperator = @$filter["z_dont_reload"];
        $this->dont_reload->AdvancedSearch->SearchCondition = @$filter["v_dont_reload"];
        $this->dont_reload->AdvancedSearch->SearchValue2 = @$filter["y_dont_reload"];
        $this->dont_reload->AdvancedSearch->SearchOperator2 = @$filter["w_dont_reload"];
        $this->dont_reload->AdvancedSearch->save();

        // Field default_bookmark
        $this->default_bookmark->AdvancedSearch->SearchValue = @$filter["x_default_bookmark"];
        $this->default_bookmark->AdvancedSearch->SearchOperator = @$filter["z_default_bookmark"];
        $this->default_bookmark->AdvancedSearch->SearchCondition = @$filter["v_default_bookmark"];
        $this->default_bookmark->AdvancedSearch->SearchValue2 = @$filter["y_default_bookmark"];
        $this->default_bookmark->AdvancedSearch->SearchOperator2 = @$filter["w_default_bookmark"];
        $this->default_bookmark->AdvancedSearch->save();

        // Field show_to_guests
        $this->show_to_guests->AdvancedSearch->SearchValue = @$filter["x_show_to_guests"];
        $this->show_to_guests->AdvancedSearch->SearchOperator = @$filter["z_show_to_guests"];
        $this->show_to_guests->AdvancedSearch->SearchCondition = @$filter["v_show_to_guests"];
        $this->show_to_guests->AdvancedSearch->SearchValue2 = @$filter["y_show_to_guests"];
        $this->show_to_guests->AdvancedSearch->SearchOperator2 = @$filter["w_show_to_guests"];
        $this->show_to_guests->AdvancedSearch->save();
        ...
        // Field update_link
        $this->update_link->AdvancedSearch->SearchValue = @$filter["x_update_link"];
        $this->update_link->AdvancedSearch->SearchOperator = @$filter["z_update_link"];
        $this->update_link->AdvancedSearch->SearchCondition = @$filter["v_update_link"];
        $this->update_link->AdvancedSearch->SearchValue2 = @$filter["y_update_link"];
        $this->update_link->AdvancedSearch->SearchOperator2 = @$filter["w_update_link"];
        $this->update_link->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->folder, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->icon, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->bar_name, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->link, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->update_link, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->version, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->bar_width); // bar_width
            $this->updateSort($this->bar_name); // bar_name
            $this->updateSort($this->dont_reload); // dont_reload
            $this->updateSort($this->default_bookmark); // default_bookmark
            $this->updateSort($this->show_to_guests); // show_to_guests
            $this->updateSort($this->link); // link
            $this->updateSort($this->update_link); // update_link
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->width->setSort("");
                $this->height->setSort("");
                $this->bar_width->setSort("");
                $this->bar_name->setSort("");
                $this->dont_reload->setSort("");
                $this->default_bookmark->setSort("");
                $this->show_to_guests->setSort("");
                $this->link->setSort("");
                $this->update_link->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"farrowchat_applicationslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"farrowchat_applicationslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.farrowchat_applicationslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function newRow()
    {
        ...
        $row['bar_width'] = null;
        $row['bar_name'] = null;
        $row['dont_reload'] = null;
        $row['default_bookmark'] = null;
        $row['show_to_guests'] = null;
        $row['link'] = null;
        $row['update_link'] = null;
        $row['version'] = null;
        $row['active'] = null;
        return $row;
    }
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"farrowchat_applicationslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
