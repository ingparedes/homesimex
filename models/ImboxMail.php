...
/**
 * Table class for imbox_mail
 */
class ImboxMail extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'imbox_mail';
        $this->TableName = 'imbox_mail';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`imbox_mail`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id_email
        $this->id_email = new DbField('imbox_mail', 'imbox_mail', 'x_id_email', 'id_email', '`id_email`', '`id_email`', 3, 11, -1, false, '`id_email`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // sender_userid
        $this->sender_userid = new DbField('imbox_mail', 'imbox_mail', 'x_sender_userid', 'sender_userid', '`sender_userid`', '`sender_userid`', 200, 30, -1, false, '`sender_userid`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // reciever_userid
        $this->reciever_userid = new DbField('imbox_mail', 'imbox_mail', 'x_reciever_userid', 'reciever_userid', '`reciever_userid`', '`reciever_userid`', 3, 11, -1, false, '`reciever_userid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->reciever_userid->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->reciever_userid->Lookup = new Lookup('reciever_userid', 'users', false, 'id_users', ["nombres","apellidos","",""], [], [], [], [], [], [], '`nombres` ASC', '');
                break;
            case "es":
                $this->reciever_userid->Lookup = new Lookup('reciever_userid', 'users', false, 'id_users', ["nombres","apellidos","",""], [], [], [], [], [], [], '`nombres` ASC', '');
                break;
        ...
        // alerta
        $this->alerta = new DbField('imbox_mail', 'imbox_mail', 'x_alerta', 'alerta', '\'\'', '\'\'', 201, 65530, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->alerta->IsCustom = true; // Custom field
        $this->alerta->Sortable = true; // Allow sort
        $this->alerta->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->alerta->Param, "CustomMsg");
        $this->Fields['alerta'] = &$this->alerta;

        // copy_sender
        $this->copy_sender = new DbField('imbox_mail', 'imbox_mail', 'x_copy_sender', 'copy_sender', '`copy_sender`', '`copy_sender`', 200, 30, -1, false, '`copy_sender`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->copy_sender->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->copy_sender->Lookup = new Lookup('copy_sender', 'users', false, 'id_users', ["nombres","apellidos","",""], [], [], [], [], [], [], '', '');
                break;
            case "es":
                $this->copy_sender->Lookup = new Lookup('copy_sender', 'users', false, 'id_users', ["nombres","apellidos","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // sujeto
        $this->sujeto = new DbField('imbox_mail', 'imbox_mail', 'x_sujeto', 'sujeto', '`sujeto`', '`sujeto`', 200, 120, -1, false, '`sujeto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mensaje
        $this->mensaje = new DbField('imbox_mail', 'imbox_mail', 'x_mensaje', 'mensaje', '`mensaje`', '`mensaje`', 201, 65535, -1, false, '`mensaje`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // archivo
        $this->archivo = new DbField('imbox_mail', 'imbox_mail', 'x_archivo', 'archivo', '`archivo`', '`archivo`', 200, 100, -1, true, '`archivo`', false, false, false, 'FORMATTED TEXT', 'FILE');
        ...
        // tiempo
        $this->tiempo = new DbField('imbox_mail', 'imbox_mail', 'x_tiempo', 'tiempo', '`tiempo`', CastDateFieldForLike("`tiempo`", 9, "DB"), 135, 19, 9, false, '`tiempo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // estado_msg
        $this->estado_msg = new DbField('imbox_mail', 'imbox_mail', 'x_estado_msg', 'estado_msg', '`estado_msg`', '`estado_msg`', 16, 1, -1, false, '`estado_msg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->estado_msg->Sortable = true; // Allow sort
        $this->estado_msg->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->estado_msg->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->estado_msg->Param, "CustomMsg");
        $this->Fields['estado_msg'] = &$this->estado_msg;

        // id_mensaje
        $this->id_mensaje = new DbField('imbox_mail', 'imbox_mail', 'x_id_mensaje', 'id_mensaje', '`id_mensaje`', '`id_mensaje`', 3, 11, -1, false, '`id_mensaje`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`imbox_mail`";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `alerta`");
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "FIND_IN_SET('".CurrentUserID()."', sender_userid)";
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->alerta->DbValue = $row['alerta'];
        ...
        $this->estado_msg->DbValue = $row['estado_msg'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ImboxMailList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ImboxMailEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ImboxMailAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ImboxMailView";
            case Config("API_ADD_ACTION"):
                return "ImboxMailAdd";
            case Config("API_EDIT_ACTION"):
                return "ImboxMailEdit";
            case Config("API_DELETE_ACTION"):
                return "ImboxMailDelete";
            case Config("API_LIST_ACTION"):
                return "ImboxMailList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ImboxMailView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ImboxMailView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ImboxMailAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ImboxMailAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ImboxMailEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImboxMailAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ImboxMailDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->alerta->EditValue = $this->alerta->CurrentValue;
        ...
        $this->estado_msg->EditValue = $this->estado_msg->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->estado_msg);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->estado_msg);
