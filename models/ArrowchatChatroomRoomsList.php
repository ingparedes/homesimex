 ...
 * Page class
 */
class ArrowchatChatroomRoomsList extends ArrowchatChatroomRooms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatChatroomRoomsList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "farrowchat_chatroom_roomslist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ArrowchatChatroomRoomsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ArrowchatChatroomRoomsDelete";
        $this->MultiUpdateUrl = "ArrowchatChatroomRoomsUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option farrowchat_chatroom_roomslistsrch";
    ...
    public function run()
    {
        ...
        $this->disallowed_groups->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->welcome_message->AdvancedSearch->toJson(), ","); // Field welcome_message
        ...
        $filterList = Concat($filterList, $this->max_users->AdvancedSearch->toJson(), ","); // Field max_users
        $filterList = Concat($filterList, $this->limit_message_num->AdvancedSearch->toJson(), ","); // Field limit_message_num
        $filterList = Concat($filterList, $this->limit_seconds_num->AdvancedSearch->toJson(), ","); // Field limit_seconds_num
        $filterList = Concat($filterList, $this->disallowed_groups->AdvancedSearch->toJson(), ","); // Field disallowed_groups
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "farrowchat_chatroom_roomslistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->welcome_message->AdvancedSearch->SearchValue = @$filter["x_welcome_message"];
        $this->welcome_message->AdvancedSearch->SearchOperator = @$filter["z_welcome_message"];
        $this->welcome_message->AdvancedSearch->SearchCondition = @$filter["v_welcome_message"];
        $this->welcome_message->AdvancedSearch->SearchValue2 = @$filter["y_welcome_message"];
        $this->welcome_message->AdvancedSearch->SearchOperator2 = @$filter["w_welcome_message"];
        $this->welcome_message->AdvancedSearch->save();
        ...
        // Field max_users
        $this->max_users->AdvancedSearch->SearchValue = @$filter["x_max_users"];
        $this->max_users->AdvancedSearch->SearchOperator = @$filter["z_max_users"];
        $this->max_users->AdvancedSearch->SearchCondition = @$filter["v_max_users"];
        $this->max_users->AdvancedSearch->SearchValue2 = @$filter["y_max_users"];
        $this->max_users->AdvancedSearch->SearchOperator2 = @$filter["w_max_users"];
        $this->max_users->AdvancedSearch->save();

        // Field limit_message_num
        $this->limit_message_num->AdvancedSearch->SearchValue = @$filter["x_limit_message_num"];
        $this->limit_message_num->AdvancedSearch->SearchOperator = @$filter["z_limit_message_num"];
        $this->limit_message_num->AdvancedSearch->SearchCondition = @$filter["v_limit_message_num"];
        $this->limit_message_num->AdvancedSearch->SearchValue2 = @$filter["y_limit_message_num"];
        $this->limit_message_num->AdvancedSearch->SearchOperator2 = @$filter["w_limit_message_num"];
        $this->limit_message_num->AdvancedSearch->save();

        // Field limit_seconds_num
        $this->limit_seconds_num->AdvancedSearch->SearchValue = @$filter["x_limit_seconds_num"];
        $this->limit_seconds_num->AdvancedSearch->SearchOperator = @$filter["z_limit_seconds_num"];
        $this->limit_seconds_num->AdvancedSearch->SearchCondition = @$filter["v_limit_seconds_num"];
        $this->limit_seconds_num->AdvancedSearch->SearchValue2 = @$filter["y_limit_seconds_num"];
        $this->limit_seconds_num->AdvancedSearch->SearchOperator2 = @$filter["w_limit_seconds_num"];
        $this->limit_seconds_num->AdvancedSearch->save();

        // Field disallowed_groups
        $this->disallowed_groups->AdvancedSearch->SearchValue = @$filter["x_disallowed_groups"];
        $this->disallowed_groups->AdvancedSearch->SearchOperator = @$filter["z_disallowed_groups"];
        $this->disallowed_groups->AdvancedSearch->SearchCondition = @$filter["v_disallowed_groups"];
        $this->disallowed_groups->AdvancedSearch->SearchValue2 = @$filter["y_disallowed_groups"];
        $this->disallowed_groups->AdvancedSearch->SearchOperator2 = @$filter["w_disallowed_groups"];
        $this->disallowed_groups->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->welcome_message, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->image, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->_password, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->disallowed_groups, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->welcome_message); // welcome_message
            ...
            $this->updateSort($this->max_users); // max_users
            $this->updateSort($this->limit_message_num); // limit_message_num
            $this->updateSort($this->limit_seconds_num); // limit_seconds_num
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->welcome_message->setSort("");
                $this->image->setSort("");
                $this->type->setSort("");
                $this->_password->setSort("");
                $this->length->setSort("");
                $this->is_featured->setSort("");
                $this->max_users->setSort("");
                $this->limit_message_num->setSort("");
                $this->limit_seconds_num->setSort("");
                $this->disallowed_groups->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"farrowchat_chatroom_roomslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"farrowchat_chatroom_roomslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.farrowchat_chatroom_roomslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"farrowchat_chatroom_roomslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
