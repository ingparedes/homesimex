 ...
 * Page class
 */
class ArrowchatChatroomRoomsDelete extends ArrowchatChatroomRooms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatChatroomRoomsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ArrowchatChatroomRoomsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ArrowchatChatroomRoomsList"); // Return to list
                return;
            }
        }
