 ...
 * Page class
 */
class PermisosDocusersAdd extends PermisosDocusers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PermisosDocusersAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PermisosDocusersView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_permisiosuser->OldValue = $this->id_permisiosuser->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_permisiosuser'] = $this->id_permisiosuser->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // id_users
        $this->id_users->setDbValueDef($rsnew, $this->id_users->CurrentValue, null, false);
