 ...
 * Page class
 */
class ArrowchatThemesDelete extends ArrowchatThemes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatThemesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ArrowchatThemesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ArrowchatThemesList"); // Return to list
                return;
            }
        }
