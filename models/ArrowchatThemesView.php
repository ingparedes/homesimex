 ...
 * Page class
 */
class ArrowchatThemesView extends ArrowchatThemes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatThemesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ArrowchatThemesList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ArrowchatThemesList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ArrowchatThemesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
