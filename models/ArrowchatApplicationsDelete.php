 ...
 * Page class
 */
class ArrowchatApplicationsDelete extends ArrowchatApplications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatApplicationsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ArrowchatApplicationsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ArrowchatApplicationsList"); // Return to list
                return;
            }
        }
