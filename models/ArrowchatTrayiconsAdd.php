 ...
 * Page class
 */
class ArrowchatTrayiconsAdd extends ArrowchatTrayicons
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatTrayiconsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ArrowchatTrayiconsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->tray_width->CurrentValue = null;
        $this->tray_width->OldValue = $this->tray_width->CurrentValue;
        $this->tray_name->CurrentValue = null;
        $this->tray_name->OldValue = $this->tray_name->CurrentValue;
        $this->tray_location->CurrentValue = null;
        $this->tray_location->OldValue = $this->tray_location->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['tray_width'] = $this->tray_width->CurrentValue;
        $row['tray_name'] = $this->tray_name->CurrentValue;
        $row['tray_location'] = $this->tray_location->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tray_width
        $this->tray_width->setDbValueDef($rsnew, $this->tray_width->CurrentValue, null, false);

        // tray_name
        $this->tray_name->setDbValueDef($rsnew, $this->tray_name->CurrentValue, null, false);

        // tray_location
        $this->tray_location->setDbValueDef($rsnew, $this->tray_location->CurrentValue, 0, false);
