 ...
 * Page class
 */
class ArrowchatTrayiconsDelete extends ArrowchatTrayicons
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatTrayiconsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ArrowchatTrayiconsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ArrowchatTrayiconsList"); // Return to list
                return;
            }
        }
