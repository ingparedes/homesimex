 ...
 * Page class
 */
class ArrowchatStatusAdd extends ArrowchatStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatStatusAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ArrowchatStatusView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->guest_name->CurrentValue = null;
        $this->guest_name->OldValue = $this->guest_name->CurrentValue;
        $this->message->CurrentValue = null;
        $this->message->OldValue = $this->message->CurrentValue;
        $this->status->CurrentValue = null;
        $this->status->OldValue = $this->status->CurrentValue;
        $this->theme->CurrentValue = null;
        $this->theme->OldValue = $this->theme->CurrentValue;
        $this->popout->CurrentValue = null;
        $this->popout->OldValue = $this->popout->CurrentValue;
        $this->typing->CurrentValue = null;
        $this->typing->OldValue = $this->typing->CurrentValue;
        $this->hide_bar->CurrentValue = null;
        $this->hide_bar->OldValue = $this->hide_bar->CurrentValue;
        $this->play_sound->CurrentValue = 1;
        $this->window_open->CurrentValue = null;
        $this->window_open->OldValue = $this->window_open->CurrentValue;
        $this->only_names->CurrentValue = null;
        $this->only_names->OldValue = $this->only_names->CurrentValue;
        $this->chatroom_window->CurrentValue = "-1";
        $this->chatroom_stay->CurrentValue = "0";
        $this->chatroom_unfocus->CurrentValue = null;
        $this->chatroom_unfocus->OldValue = $this->chatroom_unfocus->CurrentValue;
        $this->chatroom_show_names->CurrentValue = null;
        $this->chatroom_show_names->OldValue = $this->chatroom_show_names->CurrentValue;
        $this->chatroom_block_chats->CurrentValue = null;
        $this->chatroom_block_chats->OldValue = $this->chatroom_block_chats->CurrentValue;
        $this->chatroom_sound->CurrentValue = null;
        $this->chatroom_sound->OldValue = $this->chatroom_sound->CurrentValue;
        $this->announcement->CurrentValue = 1;
        $this->unfocus_chat->CurrentValue = null;
        $this->unfocus_chat->OldValue = $this->unfocus_chat->CurrentValue;
        $this->focus_chat->CurrentValue = null;
        $this->focus_chat->OldValue = $this->focus_chat->CurrentValue;
        $this->last_message->CurrentValue = null;
        $this->last_message->OldValue = $this->last_message->CurrentValue;
        $this->clear_chats->CurrentValue = null;
        $this->clear_chats->OldValue = $this->clear_chats->CurrentValue;
        $this->apps_bookmarks->CurrentValue = null;
        $this->apps_bookmarks->OldValue = $this->apps_bookmarks->CurrentValue;
        $this->apps_other->CurrentValue = null;
        $this->apps_other->OldValue = $this->apps_other->CurrentValue;
        $this->apps_open->CurrentValue = null;
        $this->apps_open->OldValue = $this->apps_open->CurrentValue;
        $this->apps_load->CurrentValue = null;
        $this->apps_load->OldValue = $this->apps_load->CurrentValue;
        $this->block_chats->CurrentValue = null;
        $this->block_chats->OldValue = $this->block_chats->CurrentValue;
        $this->session_time->CurrentValue = 0;
        $this->is_admin->CurrentValue = 0;
        $this->is_mod->CurrentValue = 0;
        $this->hash_id->CurrentValue = "0";
    ...
    protected function newRow()
    {
        ...
        $row['guest_name'] = $this->guest_name->CurrentValue;
        $row['message'] = $this->message->CurrentValue;
        $row['status'] = $this->status->CurrentValue;
        $row['theme'] = $this->theme->CurrentValue;
        $row['popout'] = $this->popout->CurrentValue;
        $row['typing'] = $this->typing->CurrentValue;
        $row['hide_bar'] = $this->hide_bar->CurrentValue;
        $row['play_sound'] = $this->play_sound->CurrentValue;
        $row['window_open'] = $this->window_open->CurrentValue;
        $row['only_names'] = $this->only_names->CurrentValue;
        $row['chatroom_window'] = $this->chatroom_window->CurrentValue;
        $row['chatroom_stay'] = $this->chatroom_stay->CurrentValue;
        $row['chatroom_unfocus'] = $this->chatroom_unfocus->CurrentValue;
        $row['chatroom_show_names'] = $this->chatroom_show_names->CurrentValue;
        $row['chatroom_block_chats'] = $this->chatroom_block_chats->CurrentValue;
        $row['chatroom_sound'] = $this->chatroom_sound->CurrentValue;
        $row['announcement'] = $this->announcement->CurrentValue;
        $row['unfocus_chat'] = $this->unfocus_chat->CurrentValue;
        $row['focus_chat'] = $this->focus_chat->CurrentValue;
        $row['last_message'] = $this->last_message->CurrentValue;
        $row['clear_chats'] = $this->clear_chats->CurrentValue;
        $row['apps_bookmarks'] = $this->apps_bookmarks->CurrentValue;
        $row['apps_other'] = $this->apps_other->CurrentValue;
        $row['apps_open'] = $this->apps_open->CurrentValue;
        $row['apps_load'] = $this->apps_load->CurrentValue;
        ...
        $row['hash_id'] = $this->hash_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // guest_name
        $this->guest_name->setDbValueDef($rsnew, $this->guest_name->CurrentValue, null, false);
        ...
        // theme
        $this->theme->setDbValueDef($rsnew, $this->theme->CurrentValue, null, false);

        // popout
        $this->popout->setDbValueDef($rsnew, $this->popout->CurrentValue, null, false);

        // typing
        $this->typing->setDbValueDef($rsnew, $this->typing->CurrentValue, null, false);
        ...
        $this->hide_bar->setDbValueDef($rsnew, $tmpBool, null, false);
        ...
        $this->play_sound->setDbValueDef($rsnew, $tmpBool, null, strval($this->play_sound->CurrentValue) == "");
        ...
        $this->window_open->setDbValueDef($rsnew, $tmpBool, null, false);
        ...
        $this->only_names->setDbValueDef($rsnew, $tmpBool, null, false);

        // chatroom_window
        $this->chatroom_window->setDbValueDef($rsnew, $this->chatroom_window->CurrentValue, "", strval($this->chatroom_window->CurrentValue) == "");

        // chatroom_stay
        $this->chatroom_stay->setDbValueDef($rsnew, $this->chatroom_stay->CurrentValue, "", strval($this->chatroom_stay->CurrentValue) == "");

        // chatroom_unfocus
        $this->chatroom_unfocus->setDbValueDef($rsnew, $this->chatroom_unfocus->CurrentValue, null, false);
        ...
        $this->chatroom_show_names->setDbValueDef($rsnew, $tmpBool, null, false);
        ...
        $this->chatroom_block_chats->setDbValueDef($rsnew, $tmpBool, null, false);
        ...
        $this->chatroom_sound->setDbValueDef($rsnew, $tmpBool, null, false);
        ...
        $this->announcement->setDbValueDef($rsnew, $tmpBool, 0, strval($this->announcement->CurrentValue) == "");

        // unfocus_chat
        $this->unfocus_chat->setDbValueDef($rsnew, $this->unfocus_chat->CurrentValue, null, false);

        // focus_chat
        $this->focus_chat->setDbValueDef($rsnew, $this->focus_chat->CurrentValue, null, false);

        // last_message
        $this->last_message->setDbValueDef($rsnew, $this->last_message->CurrentValue, null, false);

        // clear_chats
        $this->clear_chats->setDbValueDef($rsnew, $this->clear_chats->CurrentValue, null, false);

        // apps_bookmarks
        $this->apps_bookmarks->setDbValueDef($rsnew, $this->apps_bookmarks->CurrentValue, null, false);

        // apps_other
        $this->apps_other->setDbValueDef($rsnew, $this->apps_other->CurrentValue, null, false);

        // apps_open
        $this->apps_open->setDbValueDef($rsnew, $this->apps_open->CurrentValue, null, false);

        // apps_load
        $this->apps_load->setDbValueDef($rsnew, $this->apps_load->CurrentValue, null, false);

        // block_chats
        $this->block_chats->setDbValueDef($rsnew, $this->block_chats->CurrentValue, null, false);

        // session_time
        $this->session_time->setDbValueDef($rsnew, $this->session_time->CurrentValue, 0, strval($this->session_time->CurrentValue) == "");
        ...
        // hash_id
        $this->hash_id->setDbValueDef($rsnew, $this->hash_id->CurrentValue, "", strval($this->hash_id->CurrentValue) == "");
