...
class Email2 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // copy_sender
        $this->copy_sender = new DbField('email2', 'email', 'x_copy_sender', 'copy_sender', '`copy_sender`', '`copy_sender`', 200, 30, -1, false, '`copy_sender`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->copy_sender->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->copy_sender->Lookup = new Lookup('copy_sender', 'users', false, 'id_users', ["nombres","apellidos","",""], [], [], [], [], [], [], '`nombres` ASC', '');
                break;
            case "es":
                $this->copy_sender->Lookup = new Lookup('copy_sender', 'users', false, 'id_users', ["nombres","apellidos","",""], [], [], [], [], [], [], '`nombres` ASC', '');
                break;
        ...
        $this->sujeto->Required = true; // Required field
        ...
        $this->archivo->Upload->UploadMultiple = true;
        $this->archivo->UploadMaxFileCount = 0;
        ...
        // estado_msg
        $this->estado_msg = new DbField('email2', 'email', 'x_estado_msg', 'estado_msg', '`estado_msg`', '`estado_msg`', 16, 1, -1, false, '`estado_msg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function deleteUploadedFiles($row)
    {
        ...
        $oldFiles = EmptyValue($row['archivo']) ? [] : explode(Config("MULTIPLE_UPLOAD_SEPARATOR"), $row['archivo']);
