 ...
 * Page class
 */
class PermisosDocusersView extends PermisosDocusers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PermisosDocusersView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_permisiosuser") ?? Route("id_permisiosuser")) !== null) {
            $this->RecKey["id_permisiosuser"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_permisiosuser") ?? Route("id_permisiosuser")) !== null) {
                ...
                $this->RecKey["id_permisiosuser"] = $this->id_permisiosuser->QueryStringValue;
            } elseif (Post("id_permisiosuser") !== null) {
                $this->id_permisiosuser->setFormValue(Post("id_permisiosuser"));
                $this->RecKey["id_permisiosuser"] = $this->id_permisiosuser->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_permisiosuser->setQueryStringValue($keyValue);
                $this->RecKey["id_permisiosuser"] = $this->id_permisiosuser->QueryStringValue;
            } else {
                $returnUrl = "PermisosDocusersList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PermisosDocusersList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PermisosDocusersList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
