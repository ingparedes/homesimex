 ...
 * Page class
 */
class SendEmail2Delete extends SendEmail2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SendEmail2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SendEmail2List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SendEmail2List"); // Return to list
                return;
            }
        }
