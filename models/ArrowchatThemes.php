...
/**
 * Table class for arrowchat_themes
 */
class ArrowchatThemes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'arrowchat_themes';
        $this->TableName = 'arrowchat_themes';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`arrowchat_themes`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('arrowchat_themes', 'arrowchat_themes', 'x_id', 'id', '`id`', '`id`', 19, 3, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // folder
        $this->folder = new DbField('arrowchat_themes', 'arrowchat_themes', 'x_folder', 'folder', '`folder`', '`folder`', 200, 25, -1, false, '`folder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // name
        $this->name = new DbField('arrowchat_themes', 'arrowchat_themes', 'x_name', 'name', '`name`', '`name`', 200, 100, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // active
        $this->active = new DbField('arrowchat_themes', 'arrowchat_themes', 'x_active', 'active', '`active`', '`active`', 17, 1, -1, false, '`active`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->active->Nullable = false; // NOT NULL field
        $this->active->Sortable = true; // Allow sort
        $this->active->DataType = DATATYPE_BOOLEAN;
        switch ($CurrentLanguage) {
            case "en":
                $this->active->Lookup = new Lookup('active', 'arrowchat_themes', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            case "es":
                $this->active->Lookup = new Lookup('active', 'arrowchat_themes', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // update_link
        $this->update_link = new DbField('arrowchat_themes', 'arrowchat_themes', 'x_update_link', 'update_link', '`update_link`', '`update_link`', 200, 191, -1, false, '`update_link`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // version
        $this->version = new DbField('arrowchat_themes', 'arrowchat_themes', 'x_version', 'version', '`version`', '`version`', 200, 20, -1, false, '`version`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // default
        $this->_default = new DbField('arrowchat_themes', 'arrowchat_themes', 'x__default', 'default', '`default`', '`default`', 17, 1, -1, false, '`default`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->_default->Nullable = false; // NOT NULL field
        $this->_default->Sortable = true; // Allow sort
        $this->_default->DataType = DATATYPE_BOOLEAN;
        switch ($CurrentLanguage) {
            case "en":
                $this->_default->Lookup = new Lookup('default', 'arrowchat_themes', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            case "es":
                $this->_default->Lookup = new Lookup('default', 'arrowchat_themes', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        $this->_default->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_default->Param, "CustomMsg");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`arrowchat_themes`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ArrowchatThemesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ArrowchatThemesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ArrowchatThemesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ArrowchatThemesView";
            case Config("API_ADD_ACTION"):
                return "ArrowchatThemesAdd";
            case Config("API_EDIT_ACTION"):
                return "ArrowchatThemesEdit";
            case Config("API_DELETE_ACTION"):
                return "ArrowchatThemesDelete";
            case Config("API_LIST_ACTION"):
                return "ArrowchatThemesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ArrowchatThemesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ArrowchatThemesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ArrowchatThemesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ArrowchatThemesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ArrowchatThemesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ArrowchatThemesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ArrowchatThemesDelete", $this->getUrlParm());
    }
