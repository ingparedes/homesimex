 ...
 * Page class
 */
class ArrowchatChatroomMessagesDelete extends ArrowchatChatroomMessages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatChatroomMessagesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ArrowchatChatroomMessagesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ArrowchatChatroomMessagesList"); // Return to list
                return;
            }
        }
