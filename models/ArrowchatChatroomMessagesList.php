 ...
 * Page class
 */
class ArrowchatChatroomMessagesList extends ArrowchatChatroomMessages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatChatroomMessagesList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "farrowchat_chatroom_messageslist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ArrowchatChatroomMessagesAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ArrowchatChatroomMessagesDelete";
        $this->MultiUpdateUrl = "ArrowchatChatroomMessagesUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option farrowchat_chatroom_messageslistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->global_message->AdvancedSearch->toJson(), ","); // Field global_message
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "farrowchat_chatroom_messageslistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->global_message->AdvancedSearch->SearchValue = @$filter["x_global_message"];
        $this->global_message->AdvancedSearch->SearchOperator = @$filter["z_global_message"];
        $this->global_message->AdvancedSearch->SearchCondition = @$filter["v_global_message"];
        $this->global_message->AdvancedSearch->SearchValue2 = @$filter["y_global_message"];
        $this->global_message->AdvancedSearch->SearchOperator2 = @$filter["w_global_message"];
        $this->global_message->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->global_message); // global_message
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"farrowchat_chatroom_messageslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"farrowchat_chatroom_messageslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.farrowchat_chatroom_messageslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"farrowchat_chatroom_messageslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
