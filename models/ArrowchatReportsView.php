 ...
 * Page class
 */
class ArrowchatReportsView extends ArrowchatReports
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatReportsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ArrowchatReportsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ArrowchatReportsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ArrowchatReportsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
