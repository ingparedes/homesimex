 ...
 * Page class
 */
class ArrowchatTrayiconsList extends ArrowchatTrayicons
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatTrayiconsList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "farrowchat_trayiconslist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ArrowchatTrayiconsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ArrowchatTrayiconsDelete";
        $this->MultiUpdateUrl = "ArrowchatTrayiconsUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option farrowchat_trayiconslistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->tray_width->AdvancedSearch->toJson(), ","); // Field tray_width
        $filterList = Concat($filterList, $this->tray_name->AdvancedSearch->toJson(), ","); // Field tray_name
        $filterList = Concat($filterList, $this->tray_location->AdvancedSearch->toJson(), ","); // Field tray_location
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "farrowchat_trayiconslistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field tray_width
        $this->tray_width->AdvancedSearch->SearchValue = @$filter["x_tray_width"];
        $this->tray_width->AdvancedSearch->SearchOperator = @$filter["z_tray_width"];
        $this->tray_width->AdvancedSearch->SearchCondition = @$filter["v_tray_width"];
        $this->tray_width->AdvancedSearch->SearchValue2 = @$filter["y_tray_width"];
        $this->tray_width->AdvancedSearch->SearchOperator2 = @$filter["w_tray_width"];
        $this->tray_width->AdvancedSearch->save();

        // Field tray_name
        $this->tray_name->AdvancedSearch->SearchValue = @$filter["x_tray_name"];
        $this->tray_name->AdvancedSearch->SearchOperator = @$filter["z_tray_name"];
        $this->tray_name->AdvancedSearch->SearchCondition = @$filter["v_tray_name"];
        $this->tray_name->AdvancedSearch->SearchValue2 = @$filter["y_tray_name"];
        $this->tray_name->AdvancedSearch->SearchOperator2 = @$filter["w_tray_name"];
        $this->tray_name->AdvancedSearch->save();

        // Field tray_location
        $this->tray_location->AdvancedSearch->SearchValue = @$filter["x_tray_location"];
        $this->tray_location->AdvancedSearch->SearchOperator = @$filter["z_tray_location"];
        $this->tray_location->AdvancedSearch->SearchCondition = @$filter["v_tray_location"];
        $this->tray_location->AdvancedSearch->SearchValue2 = @$filter["y_tray_location"];
        $this->tray_location->AdvancedSearch->SearchOperator2 = @$filter["w_tray_location"];
        $this->tray_location->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->tray_name, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->tray_width); // tray_width
            $this->updateSort($this->tray_name); // tray_name
            $this->updateSort($this->tray_location); // tray_location
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->width->setSort("");
                $this->height->setSort("");
                $this->tray_width->setSort("");
                $this->tray_name->setSort("");
                $this->tray_location->setSort("");
                $this->active->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"farrowchat_trayiconslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"farrowchat_trayiconslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.farrowchat_trayiconslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"farrowchat_trayiconslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
