 ...
 * Page class
 */
class ArrowchatApplicationsEdit extends ArrowchatApplications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatApplicationsEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // bar_width
            $this->bar_width->setDbValueDef($rsnew, $this->bar_width->CurrentValue, null, $this->bar_width->ReadOnly);

            // bar_name
            $this->bar_name->setDbValueDef($rsnew, $this->bar_name->CurrentValue, null, $this->bar_name->ReadOnly);
            ...
            $this->dont_reload->setDbValueDef($rsnew, $tmpBool, null, $this->dont_reload->ReadOnly);
            ...
            $this->default_bookmark->setDbValueDef($rsnew, $tmpBool, null, $this->default_bookmark->ReadOnly);
            ...
            $this->show_to_guests->setDbValueDef($rsnew, $tmpBool, null, $this->show_to_guests->ReadOnly);
