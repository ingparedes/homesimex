 ...
 * Page class
 */
class ResmensajeDelete extends Resmensaje
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResmensajeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ResmensajeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ResmensajeList"); // Return to list
                return;
            }
        }
