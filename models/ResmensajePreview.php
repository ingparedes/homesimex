 ...
 * Page class
 */
class ResmensajePreview extends Resmensaje
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ResmensajePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "mensajes") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=mensajes&" . GetForeignKeyUrl("fk_id_inyect", $this->id_inyect->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "mensajes") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->id_inyect->setQueryStringValue($val);
            }
        }
    }
