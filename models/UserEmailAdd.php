 ...
 * Page class
 */
class UserEmailAdd extends UserEmail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserEmailAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "UserEmailView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_user_email->OldValue = $this->id_user_email->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_user_email'] = $this->id_user_email->CurrentValue;
