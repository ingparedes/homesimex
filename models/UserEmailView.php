 ...
 * Page class
 */
class UserEmailView extends UserEmail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserEmailView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_user_email") ?? Route("id_user_email")) !== null) {
            $this->RecKey["id_user_email"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_user_email") ?? Route("id_user_email")) !== null) {
                ...
                $this->RecKey["id_user_email"] = $this->id_user_email->QueryStringValue;
            } elseif (Post("id_user_email") !== null) {
                $this->id_user_email->setFormValue(Post("id_user_email"));
                $this->RecKey["id_user_email"] = $this->id_user_email->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_user_email->setQueryStringValue($keyValue);
                $this->RecKey["id_user_email"] = $this->id_user_email->QueryStringValue;
            } else {
                $returnUrl = "UserEmailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UserEmailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "UserEmailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
