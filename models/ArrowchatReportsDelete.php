 ...
 * Page class
 */
class ArrowchatReportsDelete extends ArrowchatReports
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatReportsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ArrowchatReportsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ArrowchatReportsList"); // Return to list
                return;
            }
        }
