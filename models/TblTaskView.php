 ...
 * Page class
 */
class TblTaskView extends TblTask
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TblTaskView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TblTaskList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TblTaskList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "TblTaskList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
