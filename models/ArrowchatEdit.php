 ...
 * Page class
 */
class ArrowchatEdit extends Arrowchat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // from
            $this->_from->setDbValueDef($rsnew, $this->_from->CurrentValue, "", $this->_from->ReadOnly);

            // to
            $this->to->setDbValueDef($rsnew, $this->to->CurrentValue, "", $this->to->ReadOnly);
            ...
            // read
            $this->read->setDbValueDef($rsnew, $this->read->CurrentValue, 0, $this->read->ReadOnly);
            ...
            // direction
            $this->direction->setDbValueDef($rsnew, $this->direction->CurrentValue, 0, $this->direction->ReadOnly);
