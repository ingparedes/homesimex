 ...
 * Page class
 */
class ArrowchatChatroomRoomsAdd extends ArrowchatChatroomRooms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatChatroomRoomsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ArrowchatChatroomRoomsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->welcome_message->CurrentValue = null;
        $this->welcome_message->OldValue = $this->welcome_message->CurrentValue;
        ...
        $this->is_featured->CurrentValue = null;
        $this->is_featured->OldValue = $this->is_featured->CurrentValue;
        $this->max_users->CurrentValue = 0;
        $this->limit_message_num->CurrentValue = 3;
        $this->limit_seconds_num->CurrentValue = 10;
        $this->disallowed_groups->CurrentValue = null;
        $this->disallowed_groups->OldValue = $this->disallowed_groups->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['welcome_message'] = $this->welcome_message->CurrentValue;
        ...
        $row['is_featured'] = $this->is_featured->CurrentValue;
        $row['max_users'] = $this->max_users->CurrentValue;
        $row['limit_message_num'] = $this->limit_message_num->CurrentValue;
        $row['limit_seconds_num'] = $this->limit_seconds_num->CurrentValue;
        $row['disallowed_groups'] = $this->disallowed_groups->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // welcome_message
        $this->welcome_message->setDbValueDef($rsnew, $this->welcome_message->CurrentValue, null, false);
        ...
        $this->type->setDbValueDef($rsnew, $tmpBool, 0, false);
        ...
        $this->is_featured->setDbValueDef($rsnew, $tmpBool, null, false);

        // max_users
        $this->max_users->setDbValueDef($rsnew, $this->max_users->CurrentValue, 0, strval($this->max_users->CurrentValue) == "");

        // limit_message_num
        $this->limit_message_num->setDbValueDef($rsnew, $this->limit_message_num->CurrentValue, 0, strval($this->limit_message_num->CurrentValue) == "");

        // limit_seconds_num
        $this->limit_seconds_num->setDbValueDef($rsnew, $this->limit_seconds_num->CurrentValue, 0, strval($this->limit_seconds_num->CurrentValue) == "");

        // disallowed_groups
        $this->disallowed_groups->setDbValueDef($rsnew, $this->disallowed_groups->CurrentValue, "", false);
