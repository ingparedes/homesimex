...
class CalificacionEdit extends Calificacion
{
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_calificacion") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_calificacion->setQueryStringValue($keyValue);
                $this->id_calificacion->setOldValue($this->id_calificacion->QueryStringValue);
            } elseif (Post("id_calificacion") !== null) {
                $this->id_calificacion->setFormValue(Post("id_calificacion"));
                $this->id_calificacion->setOldValue($this->id_calificacion->FormValue);
            } else {
