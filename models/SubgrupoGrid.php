...
class SubgrupoGrid extends Subgrupo
{
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_descripcion_subgrupo") && $CurrentForm->hasValue("o_descripcion_subgrupo") && $this->descripcion_subgrupo->CurrentValue != $this->descripcion_subgrupo->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->descripcion_subgrupo->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_descripcion_subgrupo")) {
            $this->descripcion_subgrupo->setOldValue($CurrentForm->getValue("o_descripcion_subgrupo"));
        }
