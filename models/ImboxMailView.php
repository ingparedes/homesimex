 ...
 * Page class
 */
class ImboxMailView extends ImboxMail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImboxMailView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_email") ?? Route("id_email")) !== null) {
                ...
                $returnUrl = "ImboxMailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ImboxMailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ImboxMailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
