 ...
 * Page class
 */
class ArrowchatTrayiconsView extends ArrowchatTrayicons
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatTrayiconsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ArrowchatTrayiconsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ArrowchatTrayiconsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ArrowchatTrayiconsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
