 ...
 * Page class
 */
class CalificacionEmailAdd extends CalificacionEmail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CalificacionEmailAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CalificacionEmailView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_calificacion_email->OldValue = $this->id_calificacion_email->CurrentValue;
        $this->id_calificacion->CurrentValue = null;
        $this->id_calificacion->OldValue = $this->id_calificacion->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_calificacion_email'] = $this->id_calificacion_email->CurrentValue;
        $row['id_calificacion'] = $this->id_calificacion->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // id_calificacion
        $this->id_calificacion->setDbValueDef($rsnew, $this->id_calificacion->CurrentValue, null, false);

        // id_user_email
        $this->id_user_email->setDbValueDef($rsnew, $this->id_user_email->CurrentValue, null, false);
