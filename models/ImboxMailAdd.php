 ...
 * Page class
 */
class ImboxMailAdd extends ImboxMail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImboxMailAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ImboxMailView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->alerta->CurrentValue = null;
        $this->alerta->OldValue = $this->alerta->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['alerta'] = $this->alerta->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // alerta
        $this->alerta->setDbValueDef($rsnew, $this->alerta->CurrentValue, "", false);
