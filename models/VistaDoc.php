...
/**
 * Table class for vista_doc
 */
class VistaDoc extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'vista_doc';
        $this->TableName = 'vista_doc';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`vista_doc`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id_file
        $this->id_file = new DbField('vista_doc', 'vista_doc', 'x_id_file', 'id_file', '`id_file`', '`id_file`', 3, 11, -1, false, '`id_file`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // id_users
        $this->id_users = new DbField('vista_doc', 'vista_doc', 'x_id_users', 'id_users', '`id_users`', '`id_users`', 3, 11, -1, false, '`id_users`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // perfil
        $this->perfil = new DbField('vista_doc', 'vista_doc', 'x_perfil', 'perfil', '`perfil`', '`perfil`', 3, 20, -1, false, '`perfil`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // escenario
        $this->escenario = new DbField('vista_doc', 'vista_doc', 'x_escenario', 'escenario', '`escenario`', '`escenario`', 3, 11, -1, false, '`escenario`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // file_name
        $this->file_name = new DbField('vista_doc', 'vista_doc', 'x_file_name', 'file_name', '`file_name`', '`file_name`', 200, 100, -1, false, '`file_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`vista_doc`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VistaDocList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VistaDocView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VistaDocEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VistaDocAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VistaDocView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VistaDocView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VistaDocAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VistaDocAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VistaDocEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VistaDocAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VistaDocDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        $this->escenario->ViewValue = FormatNumber($this->escenario->ViewValue, 0, -2, -2, -2);
    ...
    public function renderEditRow()
    {
        ...
        $this->escenario->EditValue = $this->escenario->CurrentValue;
