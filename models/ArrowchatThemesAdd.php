 ...
 * Page class
 */
class ArrowchatThemesAdd extends ArrowchatThemes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatThemesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ArrowchatThemesView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->_default->CurrentValue = null;
        $this->_default->OldValue = $this->_default->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['default'] = $this->_default->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        $this->_default->setDbValueDef($rsnew, $tmpBool, 0, false);
