 ...
 * Page class
 */
class ArrowchatNotificationsMarkupEdit extends ArrowchatNotificationsMarkup
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatNotificationsMarkupEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // markup
            $this->markup->setDbValueDef($rsnew, $this->markup->CurrentValue, "", $this->markup->ReadOnly);
