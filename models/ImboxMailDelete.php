 ...
 * Page class
 */
class ImboxMailDelete extends ImboxMail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImboxMailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ImboxMailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ImboxMailList"); // Return to list
                return;
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $curVal = strval($this->reciever_userid->CurrentValue);
            if ($curVal != "") {
            ...
            // copy_sender
            $curVal = strval($this->copy_sender->CurrentValue);
            if ($curVal != "") {
