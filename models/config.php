<?php 
	...
	*/
	...
	define('DB_USERNAME','simexamericas_usuario'); 
	define('DB_PASSWORD','{[?g^zh]Trv2'); 
	define('DB_NAME','simexamericas_sandbox');	
	...
	*/
	...
	define('DB_USERTABLE_USERID','id_users'); 
	define('DB_USERTABLE_AVATAR','img_user'); 
