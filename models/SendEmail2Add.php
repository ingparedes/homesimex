 ...
 * Page class
 */
class SendEmail2Add extends SendEmail2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SendEmail2Add";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SendEmail2View") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_sendemail->OldValue = $this->id_sendemail->CurrentValue;
        ...
        $this->de_user->CurrentValue = null;
        $this->de_user->OldValue = $this->de_user->CurrentValue;
        $this->copy_user->CurrentValue = null;
        $this->copy_user->OldValue = $this->copy_user->CurrentValue;
        $this->para_user->CurrentValue = null;
        $this->para_user->OldValue = $this->para_user->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_sendemail'] = $this->id_sendemail->CurrentValue;
        ...
        $row['de_user'] = $this->de_user->CurrentValue;
        $row['copy_user'] = $this->copy_user->CurrentValue;
        $row['para_user'] = $this->para_user->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // copy_user
        $this->copy_user->setDbValueDef($rsnew, $this->copy_user->CurrentValue, null, false);

        // para_user
        $this->para_user->setDbValueDef($rsnew, $this->para_user->CurrentValue, null, false);
        if ($this->archivo->Visible && !$this->archivo->Upload->KeepFile) {
