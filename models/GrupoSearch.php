...
class GrupoSearch extends Grupo
{
    ...
    // Page object name
    public $PageObjName = "GrupoSearch";
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->imgen_grupo); // imgen_grupo
        $this->buildSearchUrl($srchUrl, $this->nombre_grupo); // nombre_grupo
        $this->buildSearchUrl($srchUrl, $this->descripcion_grupo); // descripcion_grupo
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->imgen_grupo->AdvancedSearch->post()) {
            $hasValue = true;
        }
        if ($this->nombre_grupo->AdvancedSearch->post()) {
            $hasValue = true;
        }
        if ($this->descripcion_grupo->AdvancedSearch->post()) {
            $hasValue = true;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->color->ViewValue = htmlentities($this->color->ViewValue);
            ...
            $curVal = trim(strval($this->id_escenario->AdvancedSearch->SearchValue));
            if ($curVal != "") {
                $this->id_escenario->AdvancedSearch->ViewValue = $this->id_escenario->lookupCacheOption($curVal);
            } else {
                $this->id_escenario->AdvancedSearch->ViewValue = $this->id_escenario->Lookup !== null && is_array($this->id_escenario->Lookup->Options) ? $curVal : null;
            }
            if ($this->id_escenario->AdvancedSearch->ViewValue !== null) { // Load from cache
                $this->id_escenario->EditValue = array_values($this->id_escenario->Lookup->Options);
            } else { // Lookup from database
                if ($curVal == "") {
                    $filterWrk = "0=1";
                } else {
                    $filterWrk = "`id_users`" . SearchString("=", $this->id_escenario->AdvancedSearch->SearchValue, DATATYPE_NUMBER, "");
                }
                $lookupFilter = function() {
                    return "perfil = '2'";
                };
            ...
            $this->id_grupo->EditValue = HtmlEncode($this->id_grupo->AdvancedSearch->SearchValue);
            ...
            if (!$this->imgen_grupo->Raw) {
                $this->imgen_grupo->AdvancedSearch->SearchValue = HtmlDecode($this->imgen_grupo->AdvancedSearch->SearchValue);
            }
            $this->imgen_grupo->EditValue = HtmlEncode($this->imgen_grupo->AdvancedSearch->SearchValue);
            $this->imgen_grupo->PlaceHolder = RemoveHtml($this->imgen_grupo->caption());

            // nombre_grupo
            $this->nombre_grupo->EditAttrs["class"] = "form-control";
            $this->nombre_grupo->EditCustomAttributes = "";
            if (!$this->nombre_grupo->Raw) {
                $this->nombre_grupo->AdvancedSearch->SearchValue = HtmlDecode($this->nombre_grupo->AdvancedSearch->SearchValue);
            }
            $this->nombre_grupo->EditValue = HtmlEncode($this->nombre_grupo->AdvancedSearch->SearchValue);
            ...
            if (!$this->descripcion_grupo->Raw) {
                $this->descripcion_grupo->AdvancedSearch->SearchValue = HtmlDecode($this->descripcion_grupo->AdvancedSearch->SearchValue);
            }
            $this->descripcion_grupo->EditValue = HtmlEncode($this->descripcion_grupo->AdvancedSearch->SearchValue);
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->id_grupo->AdvancedSearch->SearchValue)) {
            $this->id_grupo->addErrorMessage($this->id_grupo->getErrorMessage(false));
        }
    ...
    public function loadAdvancedSearch()
    {
        ...
        $this->imgen_grupo->AdvancedSearch->load();
        $this->nombre_grupo->AdvancedSearch->load();
        $this->descripcion_grupo->AdvancedSearch->load();
