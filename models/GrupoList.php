...
class GrupoList extends Grupo
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->descripcion_grupo); // descripcion_grupo
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'subgrupo')) {
            ...
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'grupo')) {
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'grupo')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=subgrupo");
        ...
        if ($Security->allowList(CurrentProjectID() . 'users')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("UsersList?" . Config("TABLE_SHOW_MASTER") . "=grupo&" . GetForeignKeyUrl("fk_id_grupo", $this->id_grupo->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
    ...
    protected function renderListOptionsExt()
    {
        ...
        if ($this->DetailPages && $this->DetailPages["users"] && $this->DetailPages["users"]->Visible) {
            ...
            if ($Security->allowList(CurrentProjectID() . 'grupo')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("UsersList?" . Config("TABLE_SHOW_MASTER") . "=grupo&" . GetForeignKeyUrl("fk_id_grupo", $this->id_grupo->CurrentValue) . "");
