 ...
 * Page class
 */
class SendEmail2View extends SendEmail2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SendEmail2View";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_sendemail") ?? Route("id_sendemail")) !== null) {
            $this->RecKey["id_sendemail"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_sendemail") ?? Route("id_sendemail")) !== null) {
                ...
                $this->RecKey["id_sendemail"] = $this->id_sendemail->QueryStringValue;
            } elseif (Post("id_sendemail") !== null) {
                $this->id_sendemail->setFormValue(Post("id_sendemail"));
                $this->RecKey["id_sendemail"] = $this->id_sendemail->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_sendemail->setQueryStringValue($keyValue);
                $this->RecKey["id_sendemail"] = $this->id_sendemail->QueryStringValue;
            } else {
                $returnUrl = "SendEmail2List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SendEmail2List"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "SendEmail2List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
