...
class Calificacion extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id_calificacion
        $this->id_calificacion = new DbField('calificacion', 'calificacion', 'x_id_calificacion', 'id_calificacion', '`id_calificacion`', '`id_calificacion`', 3, 5, -1, false, '`id_calificacion`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // descripcion
        $this->descripcion = new DbField('calificacion', 'calificacion', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 200, 50, -1, false, '`descripcion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            ...
            $val = $this->id_calificacion->OldValue !== null ? $this->id_calificacion->OldValue : $this->id_calificacion->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    {
        global $Language;
        if ($pageName == "CalificacionView") {
            return $Language->phrase("View");
        } elseif ($pageName == "CalificacionEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CalificacionAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "CalificacionAdd";
            case Config("API_EDIT_ACTION"):
                return "CalificacionEdit";
            case Config("API_DELETE_ACTION"):
                return "CalificacionDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CalificacionView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("CalificacionView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "CalificacionAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "CalificacionAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("CalificacionEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CalificacionAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("CalificacionDelete", $this->getUrlParm());
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->id_calificacion->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->id_calificacion->CurrentValue);
        } else {
