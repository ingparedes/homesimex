 ...
 * Page class
 */
class PermisosDocusersEdit extends PermisosDocusers
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'permisos_docusers';

    // Page object name
    public $PageObjName = "PermisosDocusersEdit";
    ...
    public function __construct()
    {
        ...
        // Table object (permisos_docusers)
        if (!isset($GLOBALS["permisos_docusers"]) || get_class($GLOBALS["permisos_docusers"]) == PROJECT_NAMESPACE . "permisos_docusers") {
            $GLOBALS["permisos_docusers"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'permisos_docusers');
        }
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("permisos_docusers"));
                $doc->Text = @$content;
    ...
    protected function hideFieldsForAddEdit()
    {
        if ($this->isAdd() || $this->isCopy() || $this->isGridAdd()) {
            $this->id_permisiosuser->Visible = false;
        }
    }
    ...
    public function run()
    {
        ...
        $this->id_permisiosuser->setVisibility();
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_permisiosuser") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_permisiosuser->setQueryStringValue($keyValue);
                $this->id_permisiosuser->setOldValue($this->id_permisiosuser->QueryStringValue);
            } elseif (Post("id_permisiosuser") !== null) {
                $this->id_permisiosuser->setFormValue(Post("id_permisiosuser"));
                $this->id_permisiosuser->setOldValue($this->id_permisiosuser->FormValue);
            } else {
            ...
            if (Post("action") !== null) {
                ...
                $loadByQuery = false;
                if (($keyValue = Get("id_permisiosuser") ?? Route("id_permisiosuser")) !== null) {
                    $this->id_permisiosuser->setQueryStringValue($keyValue);
                    $loadByQuery = true;
                } else {
                    $this->id_permisiosuser->CurrentValue = null;
                }
            }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("PermisosDocusersList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "PermisosDocusersList") {
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'id_permisiosuser' first before field var 'x_id_permisiosuser'
        $val = $CurrentForm->hasValue("id_permisiosuser") ? $CurrentForm->getValue("id_permisiosuser") : $CurrentForm->getValue("x_id_permisiosuser");
        if (!$this->id_permisiosuser->IsDetailKey) {
            $this->id_permisiosuser->setFormValue($val);
        }
    ...
    {
        global $CurrentForm;
        $this->id_permisiosuser->CurrentValue = $this->id_permisiosuser->FormValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // tipo_permiso
            $this->tipo_permiso->ViewValue = $this->tipo_permiso->CurrentValue;
            $this->tipo_permiso->ViewValue = FormatNumber($this->tipo_permiso->ViewValue, 0, -2, -2, -2);
            ...
            $this->tipo_permiso->EditValue = HtmlEncode($this->tipo_permiso->CurrentValue);
            ...
            $this->id_users->EditValue = HtmlEncode($this->id_users->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->id_permisiosuser->Required) {
            if (!$this->id_permisiosuser->IsDetailKey && EmptyValue($this->id_permisiosuser->FormValue)) {
                $this->id_permisiosuser->addErrorMessage(str_replace("%s", $this->id_permisiosuser->caption(), $this->id_permisiosuser->RequiredErrorMessage));
            }
        }
        ...
        if (!CheckInteger($this->tipo_permiso->FormValue)) {
            $this->tipo_permiso->addErrorMessage($this->tipo_permiso->getErrorMessage(false));
        }
        ...
        if (!CheckInteger($this->id_users->FormValue)) {
            $this->id_users->addErrorMessage($this->id_users->getErrorMessage(false));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // id_users
            $this->id_users->setDbValueDef($rsnew, $this->id_users->CurrentValue, null, $this->id_users->ReadOnly);

            // date_created
            $this->date_created->setDbValueDef($rsnew, UnFormatDateTime($this->date_created->CurrentValue, 0), null, $this->date_created->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PermisosDocusersList"), "", $this->TableVar, true);
        $pageId = "edit";
