 ...
 * Page class
 */
class ArrowchatNotificationsMarkupAdd extends ArrowchatNotificationsMarkup
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArrowchatNotificationsMarkupAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("ArrowchatNotificationsMarkupList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ArrowchatNotificationsMarkupList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ArrowchatNotificationsMarkupView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // markup
        $this->markup->setDbValueDef($rsnew, $this->markup->CurrentValue, "", false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ArrowchatNotificationsMarkupList"), "", $this->TableVar, true);
